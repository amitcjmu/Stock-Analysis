...
export const CacheEventMonitor: React.FC<CacheEventMonitorProps> = ({
  ...
  const {
    ...
    clientAccountId,
    engagementId,
    onConnect: () => console.log('✅ Cache event monitor connected'),
    onDisconnect: () => console.log('❌ Cache event monitor disconnected'),
    onError: (err) => console.error('🚨 Cache event monitor error:', err)
  });
