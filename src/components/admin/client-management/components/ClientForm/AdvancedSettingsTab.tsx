      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <Select
              value={
                formData.agent_preferences?.confidence_thresholds?.field_mapping?.toString() ||
                '0.8'
              }
              onValueChange={(value) =>
                onFormChange('agent_preferences', {
          ...
          <div>
            ...
            <Select
              value={
                formData.agent_preferences?.confidence_thresholds?.dependency_detection?.toString() ||
                '0.75'
              }
              onValueChange={(value) =>
                onFormChange('agent_preferences', {
          ...
          <div>
            ...
            <Select
              value={
                formData.agent_preferences?.confidence_thresholds?.risk_assessment?.toString() ||
                '0.85'
              }
              onValueChange={(value) =>
                onFormChange('agent_preferences', {
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                onFormChange('platform_settings', {
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-sm text-gray-600">
                Automatically discover new applications and dependencies
              </p>
            </div>
            <Switch
