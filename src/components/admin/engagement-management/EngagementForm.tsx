      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Select
              value={formData.migration_scope || ''}
              onValueChange={(value) => onFormChange('migration_scope', value)}
            >
              <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={formData.migration_phase || ''}
              onValueChange={(value) => onFormChange('migration_phase', value)}
            >
              <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              type="number"
              value={
                formData.estimated_asset_count ? formData.estimated_asset_count.toString() : ''
              }
              onChange={(e) =>
                onFormChange(
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                onFormChange('budget', e.target.value ? parseFloat(e.target.value) : null)
              }
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                onFormChange('actual_budget', e.target.value ? parseFloat(e.target.value) : null)
              }
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              type="number"
              value={
                formData.completion_percentage ? formData.completion_percentage.toString() : ''
              }
              onChange={(e) =>
                onFormChange(
