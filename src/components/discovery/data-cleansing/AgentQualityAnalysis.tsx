...
const AgentQualityAnalysis: React.FC<AgentQualityAnalysisProps> = ({
  ...
  const toggleIssueExpansion = (issueId: string): any => {
  ...
  const toggleRecommendationExpansion = (recId: string): any => {
  ...
  const startEditing = (issueId: string, currentValue: string): any => {
    setEditingIssue(issueId);
    setEditValues({ ...editValues, [issueId]: currentValue });
  };

  const cancelEditing = (): any => {
    setEditingIssue(null);
    setEditValues({});
  };

  const saveEdit = (issueId: string): any => {
