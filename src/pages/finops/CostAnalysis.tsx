...
import { useCostAnalysis, useFinOpsMetrics } from '@/hooks/finops/useFinOpsQueries';
...
const CostAnalysis = () => {
  ...
  const { analyses = [], metrics = {} } = analysisData || {};
  const costMetrics = [
    { label: 'Total Cost', value: metrics.totalCost || '$0', color: 'text-blue-600', icon: DollarSign },
    { label: 'MoM Change', value: metrics.monthOverMonth || '0%', color: 'text-green-600', icon: LineChart },
    { label: 'Cost/App', value: metrics.costPerApp || '$0', color: 'text-purple-600', icon: BarChart },
      ...
      <div className="flex-1 ml-64">
        <main className="p-8">
          <div className="max-w-7xl mx-auto">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Cost Analysis Reports</CardTitle>
              </CardHeader>
              <CardContent>
