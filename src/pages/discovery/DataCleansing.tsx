...
// Data Cleansing Specific Components
...
const DataCleansing: React.FC = () => {
  ...
  // Error state
  if (flowStateError || cleansingError) {
    return (
      <div className="flex min-h-screen bg-gray-50">
        <div className="hidden lg:block w-64 border-r bg-white">
          <Sidebar />
        ...
        <div className="flex-1 flex items-center justify-center">
          <NoDataPlaceholder
            ...
            description={`Failed to initialize Discovery Flow: ${flowStateError?.message || cleansingError?.message}`}
            actions={
              <button 
