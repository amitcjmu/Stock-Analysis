...
import { ProcessingConfiguration, StorageConfiguration, GenericConfiguration } from '../../shared/configuration-types';
import { ConditionValue, RolloverValue, FilterValue, ConfigValue, CredentialValue } from '../../shared/value-types';
...
export interface EnrichmentFailureHandling {
  ...
  timeout: string;
  retries: number;
  fallbackValues: Record<string, ConfigValue>;
}
...
export interface DestinationConfiguration {
  ...
  protocol?: string;
  format: string;
  customConfig?: GenericConfiguration;
}
