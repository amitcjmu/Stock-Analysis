...
import type { TimelineAnalysis, RiskAnalysis } from '../../shared/analysis-types';
...
export interface PlanningConstraint extends Omit<TypedConstraint, 'type' | 'impact'> {
  id: string;
...
export interface PlanningResource {
  id: string;
  name: string;
  type: 'human' | 'equipment' | 'license' | 'facility';
  allocation: number;
  availability: number;
  skills?: string[];
}
