...
function generateBenchmarkReport(suite: BenchmarkSuite): void {
  const reportLines = [
    ...
    `- **Overall Success:** ${suite.summary.overallSuccess ? '✅ PASS' : '❌ FAIL'}`,
    '',
    '## Detailed Results',
    ''
  ];
  ...
  if (failedTests.length === 0) {
    reportLines.push('🎉 All benchmarks passed! Cache implementation meets performance requirements.');
  } else {
  ...
  console.log('\n📊 Benchmark report saved to cache-benchmark-report.md');
}
