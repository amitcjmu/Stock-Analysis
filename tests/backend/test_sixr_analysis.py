...
class TestSixRDecisionEngine:
    ...
    def test_strategy_weights_initialization(self, decision_engine):
        ...
        expected_strategies = ['rehost', 'replatform', 'refactor', 'rearchitect', 'rewrite', 'retire']
    ...
    def test_custom_application_scoring(self, decision_engine, sample_parameters):
        ...
        assert all(strategy in scores for strategy in ['rehost', 'replatform', 'refactor', 'rearchitect', 'rewrite'])
    ...
    def test_confidence_calculation(self, decision_engine, sample_parameters):
        ...
        consistent_recommendation = decision_engine.get_recommendation(consistent_params)
    ...
    def test_recommendation_generation(self, decision_engine, sample_parameters):
        ...
        assert recommendation.recommended_strategy in ['rehost', 'replatform', 'refactor', 'rearchitect', 'rewrite', 'retire']
    ...
    def test_edge_case_scenarios(self, decision_engine):
        ...
        retire_score = next(score.score for score in recommendation.strategy_scores if score.strategy == 'retire')
...
class TestSixRAgentOrchestrator:
    ...
    async def test_agent_initialization(self, orchestrator):
        ...
        expected_agents = ['discovery', 'initial_analysis', 'question_generator',
                          'input_processor', 'refinement', 'validation']
    ...
    async def test_discovery_agent(self, orchestrator, sample_cmdb_data):
        ...
        with patch.object(orchestrator, '_execute_agent_task', new_callable=AsyncMock) as mock_execute:
    ...
    async def test_question_generator_agent(self, orchestrator):
        ...
        analysis_results = {
            'data_gaps': ['Code quality assessment', 'Performance metrics', 'Team expertise'],
            'preliminary_recommendation': 'refactor',
    ...
    async def test_refinement_agent(self, orchestrator):
        ...
        with patch.object(orchestrator, '_execute_agent_task', new_callable=AsyncMock) as mock_execute:
            mock_execute.return_value = {
                ...
                'refinement_rationale': ['Improved confidence due to good code quality']
            }
...
class TestAPIEndpoints:
    ...
    def test_update_parameters_endpoint(self, client):
        ...
        response = client.put(f'/sixr/analysis/{analysis_id}/parameters', json=update_data)
    ...
    def test_submit_questions_endpoint(self, client):
        ...
        response = client.post(f'/sixr/analysis/{analysis_id}/questions', json=question_data)
    ...
    def test_concurrent_analysis_support(self):
        ...
        for i in range(10):
            params = SixRParameters(
                ...
                application_type=ApplicationType.CUSTOM if i % 2 == 0 else ApplicationType.COTS
            )
