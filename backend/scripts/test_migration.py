...
async def test_migration():
    ...
    try:
        async with AsyncSessionLocal() as session:
            ...
            tables_to_check = ['crewai_flow_state_extensions', 'discovery_flows', 'data_imports', 'raw_import_records']
            ...
            return len(correct_constraints) == len(constraints) and len(constraints) >= 3
