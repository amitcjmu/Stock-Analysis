...
class PersistenceToDbMigrator:
    ...
    def map_workflow_status(self, asset_data: Dict[str, Any]) -> Dict[str, str]:
        ...
        has_basic_info = bool(
            asset_data.get("hostname") or asset_data.get("asset_name")
        )
        has_detailed_info = bool(
            asset_data.get("operating_system") or asset_data.get("environment")
        )
        has_6r_analysis = bool(
            asset_data.get("sixr_ready") or asset_data.get("recommended_6r_strategy")
        )
    ...
    def calculate_data_quality_scores(
        ...
        missing_fields = [
            field for field in critical_fields if not asset_data.get(field)
        ]
    ...
    def convert_asset_data(self, asset_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        db_asset = {
            ...
            or asset_data.get("hostname", "Unknown"),
