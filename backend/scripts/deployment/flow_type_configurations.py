...
class FlowTypeConfigurator:
    ...
    async def _configure_discovery_flow(self) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                logger.warning(
                    "UnifiedDiscoveryFlow not available, flow will use placeholder"
                )
            ...
            return {"success": False, "flow_type": "discovery", "errors": [str(e)]}
    ...
    async def _configure_assessment_flow(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "flow_type": "assessment", "errors": [str(e)]}
    ...
    async def _configure_planning_flow(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "flow_type": "planning", "errors": [str(e)]}
    ...
    async def _configure_execution_flow(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "flow_type": "execution", "errors": [str(e)]}
    ...
    async def _configure_modernize_flow(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "flow_type": "modernize", "errors": [str(e)]}
    ...
    async def _configure_finops_flow(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "flow_type": "finops", "errors": [str(e)]}
    ...
    async def _configure_observability_flow(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "flow_type": "observability", "errors": [str(e)]}
    ...
    async def _configure_decommission_flow(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "flow_type": "decommission", "errors": [str(e)]}
    ...
    async def _register_discovery_validators(self) -> None:
        ...
        async def field_mapping_validation(phase_input, flow_state, overrides=None):
            ...
            if missing_fields:
                return {
                    "valid": False,
                    "errors": [f"Missing required field mappings: {missing_fields}"],
                }
        ...
        self.validator_registry.register_validator(
            "inventory_validation", asset_validation
        )  # Reuse for inventory
        self.validator_registry.register_validator(
            "dependency_validation", asset_validation
        )  # Simplified
    ...
    async def _verify_flow_configurations(self) -> Dict[str, Any]:
        ...
        try:
                        ...
                        verification_results["verified_flows"].append(
                            {
                                ...
                                "has_validators": any(
                                    phase.validators for phase in config.phases
                                ),
            ...
            return {"verification_error": str(e), "consistency_check": False}
...
async def run_flow_type_configuration():
    ...
    try:
        ...
        if results.get("verification"):
            ...
            print(
                f"  - Consistency check: {'✅ PASSED' if verification['consistency_check'] else '❌ FAILED'}"
            )
