...
def test_import_context():
    ...
    test_payload = {
        ...
        "sample_data": [
            {"Asset_ID": "test-001", "Asset_Name": "Test Server", "Asset_Type": "Server"}
        ]
    }
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"Attributes visible in Marathon context: {check_data.get('statistics', {}).get('total_attributes', 0)}")
        else:
    ...
    try:
        ...
        print(f"Attributes visible in Demo context: {demo_check_data.get('statistics', {}).get('total_attributes', 0)}")
