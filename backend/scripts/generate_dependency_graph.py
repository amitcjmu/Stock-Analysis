...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--path",
        default="backend/app",
        help="The root directory of the Python code to analyze.",
    )
    parser.add_argument(
        "--output", default="dependency_graph.png", help="The output image file name."
    )
    ...
    if not os.path.isdir(args.path):
        ...
        logging.info(
            f"Found {dep_graph.number_of_nodes()} modules and {dep_graph.number_of_edges()} dependencies."
        )
