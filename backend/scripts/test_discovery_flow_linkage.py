        ...
        try:
            ...
            if discovery_flow:
                ...
                if discovery_flow.master_flow_id:
                    logger.info("✅ SUCCESS: Discovery flow is properly linked to master flow!")
                else:
            ...
            logger.info(f"After deletion - Discovery flow status: {discovery_flow.status}")
