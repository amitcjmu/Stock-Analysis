...
def upgrade():
    ...
    op.add_column('client_accounts', sa.Column('slug', sa.String(100), unique=True, nullable=True))
    op.add_column('client_accounts', sa.Column('industry', sa.String(100), nullable=True))
    op.add_column('client_accounts', sa.Column('company_size', sa.String(50), nullable=True))
    op.add_column('client_accounts', sa.Column('headquarters_location', sa.String(255), nullable=True))
    op.add_column('client_accounts', sa.Column('primary_contact_name', sa.String(255), nullable=True))
    op.add_column('client_accounts', sa.Column('primary_contact_email', sa.String(255), nullable=True))
    op.add_column('client_accounts', sa.Column('primary_contact_phone', sa.String(50), nullable=True))
    op.add_column('client_accounts', sa.Column('subscription_tier', sa.String(50), default='standard', nullable=True))
    op.add_column('client_accounts', sa.Column('billing_contact_email', sa.String(255), nullable=True))
    
    # Add JSON fields for complex data
    op.add_column('client_accounts', sa.Column('settings', sa.JSON(), default=lambda: {}, nullable=True))
    op.add_column('client_accounts', sa.Column('branding', sa.JSON(), default=lambda: {}, nullable=True))
    op.add_column('client_accounts', sa.Column('business_objectives', sa.JSON(), default=lambda: {
        "primary_goals": [],
        "timeframe": "",
        "success_metrics": [],
        "budget_constraints": "",
    ...
    op.add_column('client_accounts', sa.Column('it_guidelines', sa.JSON(), default=lambda: {
    ...
    op.add_column('client_accounts', sa.Column('decision_criteria', sa.JSON(), default=lambda: {
    ...
    op.add_column('client_accounts', sa.Column('agent_preferences', sa.JSON(), default=lambda: {
    ...
    op.add_column('client_accounts', sa.Column('created_by', postgresql.UUID(as_uuid=True), nullable=True))
    ...
    op.alter_column('client_accounts', 'is_mock', nullable=False, server_default=sa.text('false'))
    
    # Ensure is_active has proper default
    op.alter_column('client_accounts', 'is_active', nullable=False, server_default=sa.text('true'))
    ...
    op.add_column('engagements', sa.Column('engagement_type', sa.String(50), default='migration', nullable=True))
    op.add_column('engagements', sa.Column('status', sa.String(50), default='active', nullable=True))
    op.add_column('engagements', sa.Column('priority', sa.String(20), default='medium', nullable=True))
    
    # Add timeline fields
    op.add_column('engagements', sa.Column('start_date', sa.DateTime(timezone=True), nullable=True))
    op.add_column('engagements', sa.Column('target_completion_date', sa.DateTime(timezone=True), nullable=True))
    op.add_column('engagements', sa.Column('actual_completion_date', sa.DateTime(timezone=True), nullable=True))
    
    # Add team and contact fields
    op.add_column('engagements', sa.Column('engagement_lead_id', postgresql.UUID(as_uuid=True), nullable=True))
    op.add_column('engagements', sa.Column('client_contact_name', sa.String(255), nullable=True))
    op.add_column('engagements', sa.Column('client_contact_email', sa.String(255), nullable=True))
    
    # Add JSON fields for complex data
    op.add_column('engagements', sa.Column('settings', sa.JSON(), default=lambda: {}, nullable=True))
    op.add_column('engagements', sa.Column('migration_scope', sa.JSON(), default=lambda: {
        "target_clouds": [],
    ...
    op.add_column('engagements', sa.Column('team_preferences', sa.JSON(), default=lambda: {
        "stakeholders": [],
        "decision_makers": [],
        "technical_leads": [],
    ...
    op.add_column('engagements', sa.Column('created_by', postgresql.UUID(as_uuid=True), nullable=True))
    
    # Populate is_mock with default value for existing records
    op.execute("UPDATE engagements SET is_mock = false WHERE is_mock IS NULL")
    
    # Now make it not null
    op.alter_column('engagements', 'is_mock', nullable=False, server_default=sa.text('false'))
    
    # Ensure is_active has proper default
    op.alter_column('engagements', 'is_active', nullable=False, server_default=sa.text('true'))
...
def downgrade():
    ...
    op.drop_constraint('engagements_engagement_lead_id_fkey', 'engagements', type_='foreignkey')
    ...
    op.drop_constraint('client_accounts_created_by_fkey', 'client_accounts', type_='foreignkey')
