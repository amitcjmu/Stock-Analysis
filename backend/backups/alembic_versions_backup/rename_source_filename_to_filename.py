...
def upgrade():
    ...
    if column_exists(connection, 'data_imports', 'source_filename') and not column_exists(connection, 'data_imports', 'filename'):
    ...
    if column_exists(connection, 'data_imports', 'file_size_bytes') and not column_exists(connection, 'data_imports', 'file_size'):
    ...
    if column_exists(connection, 'data_imports', 'file_type') and not column_exists(connection, 'data_imports', 'mime_type'):
...
def downgrade():
    ...
    if column_exists(connection, 'data_imports', 'filename') and not column_exists(connection, 'data_imports', 'source_filename'):
        op.alter_column('data_imports', 'filename', new_column_name='source_filename')
    
    if column_exists(connection, 'data_imports', 'file_size') and not column_exists(connection, 'data_imports', 'file_size_bytes'):
        op.alter_column('data_imports', 'file_size', new_column_name='file_size_bytes')
    
    if column_exists(connection, 'data_imports', 'mime_type') and not column_exists(connection, 'data_imports', 'file_type'):
