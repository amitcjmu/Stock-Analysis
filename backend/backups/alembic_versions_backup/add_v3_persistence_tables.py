...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.ForeignKey("v3_data_imports.id"),
        ),
    ...
    op.create_index(
        "idx_v3_records_import", "v3_raw_import_records", ["data_import_id"]
    )
    op.create_index(
        "idx_v3_records_processed", "v3_raw_import_records", ["is_processed"]
    )
