    ...
    try:
        ...
        async with AsyncSessionLocal() as db:
            ...
            discovery_flow = create_unified_discovery_flow(
                ...
                metadata={"data_import_id": str(data_import_id)},
            ...
            if (
                ...
                and result.phase == FlowPhase.FIELD_MAPPING_APPROVAL
            ):
                ...
                if data_import_id and field_mappings:
                    async with AsyncSessionLocal() as db2:
                        ...
                        await db2.commit()
                        logger.info(
                            f"✅ Saved {len(field_mappings)-1} field mappings to database"
                        )
                ...
                async with AsyncSessionLocal() as db2:
                    ...
                    if asset_count > 0:
                        ...
                        for asset in asset_result:
                            logger.info(
                                f"  - {asset.name}: {asset.asset_type} ({asset.ip_address})"
                            )
