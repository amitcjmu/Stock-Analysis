    ...
    for i, flow_data in enumerate(FLOWS):
        ...
        flow = DiscoveryFlow(
            ...
            phase_state={
                ...
                "phase_metadata": {"source": "demo_seeding", "version": "1.0"},
            },
            agent_state={
            ...
            flow_state={
                "initialized": True,
                "configuration": {"auto_advance": True, "notification_enabled": True},
            },
            # CrewAI integration
            crewai_state_data={
            ...
            error_details=(
                {
                    "reason": flow_data.get("error_message"),
                    "timestamp": updated_at.isoformat(),
                }
                if flow_data.get("error_message")
                else None
            ),
            # Timestamps
        ...
        crew_state = CrewAIFlowStateExtensions(
            ...
            adaptation_metrics={"learning_rate": 0.05, "adaptation_success": 0.85},
            # Metadata
            created_at=created_at,
            updated_at=updated_at,
        )
...
def get_intermediate_results(flow_data: dict) -> dict:
    ...
    results = {"phase_results": {}, "validation_results": {}, "analysis_results": {}}
