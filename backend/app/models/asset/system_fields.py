...
These fields track flow coordination, phase management, and audit trails.
...
from .base import SMALL_STRING_LENGTH, DEFAULT_CURRENT_PHASE, DEFAULT_SOURCE_PHASE


class FlowTrackingFieldsMixin:
    """Mixin providing flow coordination and tracking fields for the Asset model."""
    ...
    flow_id = Column(
        ...
        info={
            ...
            "short_hint": "Legacy discovery flow reference",
            "category": "system",
        },
    )
    migration_id = Column(
    ...
    master_flow_id = Column(
        ...
        info={
            ...
            "short_hint": "Master orchestration flow",
            "category": "system",
        },
    )
    ...
    source_phase = Column(
        ...
        index=True,
        comment="The phase in which the asset was originally created.",
        info={
    ...
    current_phase = Column(
        ...
        index=True,
        comment="The current workflow phase this asset is in.",
        info={
    ...
    phase_context = Column(
        JSON,
        default=dict,
        comment="A JSON blob for storing phase-specific data or state.",
        info={
            "display_name": "Phase Context",
            "short_hint": "Phase-specific data",
            "category": "system",
        },
    )
    ...
    ai_gap_analysis_timestamp = Column(
        ...
        info={
            ...
            "short_hint": "Gap analysis completion time",
            "category": "system",
        },
    )
...
class AuditFieldsMixin:
    """Mixin providing audit and soft delete fields for the Asset model."""
    ...
    deleted_by = Column(
        ...
        info={
            ...
            "short_hint": "User who deleted record",
            "category": "audit",
        },
    )
