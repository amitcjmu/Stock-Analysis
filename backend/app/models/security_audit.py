...
class SecurityAuditLog(Base):
    ...
    event_category = Column(String(50), nullable=False, index=True)  # ROLE_CHANGE, LOGIN, ADMIN_ACCESS, etc.
    ...
    @classmethod
    def create_role_change_event(cls, actor_user_id: str, target_user_id: str, old_role: str, new_role: str, **kwargs):
        """Create a role change audit event."""
        return cls(
            event_type="ROLE_CHANGE",
            event_category="PRIVILEGE_ESCALATION" if cls._is_escalation(old_role, new_role) else "ROLE_MODIFICATION",
    ...
    @classmethod
    def create_security_violation_event(cls, user_id: str, violation_type: str, **kwargs):
