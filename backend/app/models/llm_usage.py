...
class LLMUsageLog(Base):
    ...
    )  # Reference to user system when implemented
    ...
    )  # e.g., 'asset-analysis', 'field-mapping'
...
class LLMModelPricing(Base):
    ...
    __table_args__ = (
        ...
        Index(
            "idx_model_pricing_active", "is_active", "effective_from", "effective_to"
        ),
    )
