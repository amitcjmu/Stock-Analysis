...
class ImportMetadata(BaseModel):
    ...
    filename: str = Field(
        ..., description="Original filename", example="servers_inventory.csv"
    )
    import_type: str = Field(
        ..., description="Type of data imported", example="servers"
    )
    ...
    total_records: int = Field(
        ..., description="Total number of records imported", example=150, ge=0
    )
    status: Literal["pending", "processing", "completed", "failed"] = Field(
        ..., description="Current status of the import", example="processing"
    )
    ...
    client_account_id: int = Field(
        ..., description="Client account identifier", example=1
    )
    engagement_id: int = Field(..., description="Engagement identifier", example=1)
...
class DataImportResponse(BaseModel):
    ...
    success: bool = Field(
        ..., description="Whether the import was successful", example=True
    )
    message: str = Field(
        ...,
    ...
    total_records: int = Field(
        ..., description="Number of records imported", example=150, ge=0
    )
    import_type: str = Field(
        ..., description="Type of data imported", example="servers"
    )
...
class ImportDataResponse(BaseModel):
    ...
    success: bool = Field(..., description="Whether the data retrieval was successful")
