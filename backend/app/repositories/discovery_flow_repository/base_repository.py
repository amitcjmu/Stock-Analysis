...
class DiscoveryFlowRepository(ContextAwareRepository):
    ...
    def __init__(self, db: AsyncSession, client_account_id: str, engagement_id: str = None):
        ...
        self.analytics_queries = AnalyticsQueries(db, parsed_client_id, parsed_engagement_id)
        ...
        logger.info(f"DiscoveryFlowRepository initialized - Client: {parsed_client_id}, Engagement: {parsed_engagement_id}")
    ...
    async def update_master_flow_reference(self, flow_id: str, master_flow_id: str) -> bool:
        ...
        return await self.flow_commands.update_master_flow_reference(flow_id, master_flow_id)
    
    async def transition_to_assessment_phase(self, flow_id: str, assessment_flow_id: str) -> bool:
        """Transition flow to assessment phase"""
        return await self.flow_commands.transition_to_assessment_phase(flow_id, assessment_flow_id)
