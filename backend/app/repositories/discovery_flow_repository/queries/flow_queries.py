...
class FlowQueries:
    ...
    async def get_by_flow_id_global(self, flow_id: str) -> Optional[DiscoveryFlow]:
        ...
        logger.warning(
            f"🔒 SECURITY AUDIT: Global query attempted for flow_id={flow_id} by client={self.client_account_id}"
        )
            ...
            .where(
                and_(
                    ...
                    ~and_(
                        ...
                        DiscoveryFlow.dependency_analysis_completed
                        == True,  # noqa: E712
                        DiscoveryFlow.tech_debt_assessment_completed
                        == True,  # noqa: E712
                    ),
                )
            )
    ...
    async def get_completed_flows(self, limit: int = 10) -> List[DiscoveryFlow]:
        ...
        stmt = (
            ...
            .order_by(desc(DiscoveryFlow.completed_at))
            .limit(limit)
        )
