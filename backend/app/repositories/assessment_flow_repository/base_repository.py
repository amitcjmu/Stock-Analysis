...
class AssessmentFlowRepository(ContextAwareRepository):
    ...
    async def update_flow_phase(
        ...
        await self._flow_specs.update_master_flow_status(flow_id, status or "running", current_phase)
    ...
    async def save_architecture_standards(
        ...
        await self._architecture_commands.save_architecture_standards(engagement_id, standards)
    ...
    async def save_application_overrides(
        ...
        await self._architecture_commands.save_application_overrides(flow_id, app_id, overrides)
    ...
    async def save_application_components(
        ...
        await self._component_commands.save_application_components(flow_id, app_id, components)
    ...
    async def save_tech_debt_analysis(
        ...
        await self._component_commands.save_tech_debt_analysis(flow_id, app_id, tech_debt_items)
    ...
    async def save_component_treatments(
        ...
        await self._component_commands.save_component_treatments(flow_id, app_id, treatments)
    ...
    async def save_learning_feedback(
        ...
        await self._feedback_commands.save_learning_feedback(flow_id, decision_id, feedback)
    ...
    async def _update_master_flow_status(
        ...
        await self._flow_specs.update_master_flow_status(flow_id, status, current_phase, phase_data)
