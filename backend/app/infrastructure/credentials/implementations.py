...
class CloudKMSCredentialManager(CredentialManager):
    ...
    def __init__(
        self, kms_endpoint: Optional[str] = None, api_key: Optional[str] = None
    ):
        """
        ...
        logger.info(
            f"Initialized CloudKMSCredentialManager with endpoint: {self.kms_endpoint}"
        )
...
class LocalCredentialManager(CredentialManager):
    ...
    def __init__(self, storage_path: Optional[str] = None):
        ...
        logger.info(
            f"Initialized LocalCredentialManager with storage: {self.storage_path}"
        )
