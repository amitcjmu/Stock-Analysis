...
class DeploymentConfig:
    ...
    def for_development(cls) -> "DeploymentConfig":
        ...
        return cls(
            ...
            services={
                ...
                "telemetry": ServiceConfig(implementation="noop", enabled=False),
                "authentication": ServiceConfig(
                    implementation="database", config={"session_timeout": 86400}
                ),
                "external_api": ServiceConfig(implementation="mock", enabled=True),
            },
            features={
                "cloud_kms": False,
                "sso": False,
    ...
    def for_on_premises(cls) -> "DeploymentConfig":
        ...
        return cls(
            ...
            services={
                ...
                "external_api": ServiceConfig(implementation="noop", enabled=False),
            },
            features={
                "cloud_kms": False,
                "sso": False,
        ...
        return cls(
            ...
            services={
                ...
                "external_api": ServiceConfig(
                    implementation="production", enabled=True
                ),
            },
            features={
                "cloud_kms": True,
    ...
    def for_hybrid(cls) -> "DeploymentConfig":
        ...
        return cls(
            ...
            services={
                "credentials": ServiceConfig(
                    implementation=(
                        "cloud_kms" if os.getenv("USE_CLOUD_KMS") else "local"
                    ),
                    config={
                        "endpoint": os.getenv("KMS_ENDPOINT"),
                ...
                "telemetry": ServiceConfig(
                    implementation=(
                        "cloud" if os.getenv("TELEMETRY_ENDPOINT") else "noop"
                    ),
                    config={
                        "endpoint": os.getenv("TELEMETRY_ENDPOINT"),
                        "api_key": os.getenv("TELEMETRY_API_KEY"),
                ...
                "external_api": ServiceConfig(
                    implementation=(
                        "production" if os.getenv("EXTERNAL_API_ENABLED") else "noop"
                    ),
                    enabled=True,
                ),
            },
    ...
    def get_service_config(self, service_name: str) -> ServiceConfig:
        ...
        return self.services.get(
            service_name, ServiceConfig(enabled=False, implementation="noop")
        )
