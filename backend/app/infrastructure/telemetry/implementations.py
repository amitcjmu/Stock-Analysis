...
class CloudTelemetryService(TelemetryService):
    ...
    def __init__(self, endpoint: Optional[str] = None, api_key: Optional[str] = None):
        ...
        self._metrics_cache: Dict[str, Deque[Dict[str, Any]]] = defaultdict(
    ...
    async def record_metric(
        ...
        self._buffer.append({"type": "metric", "data": metric_data})
    ...
    async def record_event(
        ...
        self._buffer.append({"type": "event", "data": event_data})
    ...
    async def log(
        ...
        self._buffer.append({"type": "log", "data": log_data})
    ...
    async def end_trace(
        ...
        self._buffer.append({"type": "trace", "data": trace_data})
    ...
    async def record_error(
        ...
        self._buffer.append({"type": "error", "data": error_data})
    ...
    async def get_metrics_summary(
        ...
        for name, metrics in self._metrics_cache.items():
            ...
            filtered_metrics = [
                ...
                if (
                    not start_time
                    or datetime.fromisoformat(m["timestamp"]) >= start_time
                )
                and (not end_time or datetime.fromisoformat(m["timestamp"]) <= end_time)
            ]
    ...
    async def get_metrics_summary(
        ...
        for name, metrics in self._metrics.items():
            ...
            filtered_metrics = [
                m
                for m in metrics
                if (not start_time or m["timestamp"] >= start_time)
                and (not end_time or m["timestamp"] <= end_time)
            ]
