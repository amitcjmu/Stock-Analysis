...
class EncryptionManager:
    ...
    def encrypt_with_aes_gcm(self, plaintext: str, associated_data: Optional[bytes] = None) -> Tuple[str, Dict[str, Any]]:
        """
    ...
    def decrypt_with_aes_gcm(self, ciphertext: str, metadata: Dict[str, Any], associated_data: Optional[bytes] = None) -> str:
        """
    ...
    def encrypt_credential(self, credential_data: Dict[str, Any], credential_type: str) -> Tuple[str, Dict[str, Any]]:
        """
    ...
    def decrypt_credential(self, encrypted_data: str, metadata: Dict[str, Any], credential_type: str) -> Dict[str, Any]:
        """
        ...
        if algorithm == "fernet":
            ...
            associated_data = credential_type.encode('utf-8')
            plaintext = self.decrypt_with_aes_gcm(encrypted_data, metadata, associated_data)
        else:
...
def encrypt_credential(credential_data: Dict[str, Any], credential_type: str) -> Tuple[str, Dict[str, Any]]:
    """Encrypt credential data"""
    return encryption_manager.encrypt_credential(credential_data, credential_type)


def decrypt_credential(encrypted_data: str, metadata: Dict[str, Any], credential_type: str) -> Dict[str, Any]:
    """Decrypt credential data"""
    return encryption_manager.decrypt_credential(encrypted_data, metadata, credential_type)
