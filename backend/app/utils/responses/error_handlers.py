...
class AuthorizationError(BaseApplicationError):
    ...
    def __init__(
        self, message: str = "Access forbidden", error_code: str = "AUTHORIZATION_ERROR"
    ):
...
class ConflictError(BaseApplicationError):
    ...
    def __init__(
        self, message: str = "Resource conflict", conflict_type: Optional[str] = None
    ):
        details = []
        if conflict_type:
...
class InternalServerError(BaseApplicationError):
    ...
    def __init__(
        self, message: str = "Internal server error", error_id: Optional[str] = None
    ):
        details = []
        if error_id:
        ...
        super().__init__(
            message, ErrorType.INTERNAL_SERVER, "INTERNAL_SERVER_ERROR", details
        )
...
class ErrorHandler:
    ...
    def _handle_application_error(
        exc: BaseApplicationError, error_id: str
    ) -> JSONResponse:
    ...
    def _handle_pydantic_validation_error(
        exc: PydanticValidationError, error_id: str
    ) -> JSONResponse:
...
def handle_database_error(
    exc: SQLAlchemyError, context: Optional[str] = None
) -> JSONResponse:
...
def handle_validation_error(
    message: str, details: Optional[List[ErrorDetails]] = None
) -> JSONResponse:
...
def handle_business_logic_error(
    message: str, error_code: str = "BUSINESS_LOGIC_ERROR"
) -> JSONResponse:
