...
class ResponseBuilder:
    ...
    def data(
        ...
        """
        response = DataResponse(message=message, data=data, count=count, meta=meta)
    ...
    def paginated(
        ...
        response = PaginatedResponse(
            message=message, data=data, count=count, pagination=pagination, meta=meta
        )
    ...
    def updated(
        ...
        return ResponseBuilder.data(
            data=data, message=message, meta=meta, status_code=status.HTTP_200_OK
        )
    ...
    def deleted(
        ...
        return ResponseBuilder.success(
            message=message, meta=meta, status_code=status.HTTP_200_OK
        )
...
def create_error_response(
    ...
    return ResponseBuilder.error(
        message, errors, error_code, error_type, meta, status_code
    )
...
def create_paginated_response(
    ...
    return ResponseBuilder.paginated(
        data, pagination, message, count, meta, status_code
    )


# Common error responses
def create_validation_error_response(
    message: str = "Validation failed", errors: Optional[List[Dict[str, Any]]] = None
) -> JSONResponse:
...
def create_forbidden_response(message: str = "Access forbidden") -> JSONResponse:
