...
class CostCalculator:
    ...
    async def estimate_cost_impact(self, strategy: str, param_values: Dict[str, float]) -> str:
    ...
    async def estimate_effort(self, strategy: str, param_values: Dict[str, float]) -> str:
