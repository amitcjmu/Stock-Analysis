...
def calculate_trend_direction(
    trend_data: List[Dict[str, Any]], metric_key: str = "quality"
) -> str:
...
def calculate_effectiveness_score(
    clarity: List[float], quality: List[float], confusion: List[float]
) -> float:
...
def calculate_resolution_effectiveness(
    resolution: List[float], confidence: List[float]
) -> float:
...
def calculate_context_effectiveness(
    relevance: List[float], alignment: List[float]
) -> float:
...
def calculate_adaptation_effectiveness(
    complexity: List[float], satisfaction: List[float]
) -> float:
