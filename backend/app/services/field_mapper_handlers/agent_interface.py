...
class AgentInterfaceHandler:
    ...
    def agent_learn_field_mapping(self, source_field: str, target_field: str, 
        ...
        try:
            if not self.mapping_engine:
                return self._fallback_learn_response(source_field, target_field, context)
            ...
            return self._fallback_learn_response(source_field, target_field, context, error=str(e))
    ...
    def agent_analyze_columns(self, columns: List[str], asset_type: str = "server") -> Dict[str, Any]:
        ...
        try:
            ...
            suggestions = self._generate_mapping_suggestions(unmapped_columns, asset_type)
    ...
    def agent_get_mapping_context(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "total_variations_learned": sum(len(v) for v in learned_mappings.values()),
    ...
    def _determine_canonical_field(self, field1: str, field2: str) -> str:
        ...
        try:
            ...
            all_canonical_names = list(base_mappings.keys()) + list(learned_mappings.keys())
    ...
    def _generate_mapping_suggestions(self, unmapped_columns: List[str], asset_type: str) -> List[Dict[str, str]]:
    ...
    # Fallback methods
    def _fallback_query_response(self, field_name: str, error: str = None) -> Dict[str, Any]:
    ...
    def _fallback_learn_response(self, source_field: str, target_field: str, 
                                context: str, error: str = None) -> Dict[str, Any]:
    ...
    def _fallback_analyze_response(self, columns: List[str], asset_type: str, 
