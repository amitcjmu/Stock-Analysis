...
class AgentRegistry:
    ...
    def __init__(self):
        ...
        logger.info(
            "Agent Registry initialized (agents will be registered on first use)"
        )
    ...
    def _initialize_all_agents(self):
        ...
        try:
            ...
            logger.info(
                f"All agents initialized successfully - {self.core.get_agents_count()} agents registered"
            )
    ...
    def update_agent_performance(
        ...
        return self.lifecycle.update_agent_performance(
            agent_id, task_duration, task_success, memory_used, confidence
        )
