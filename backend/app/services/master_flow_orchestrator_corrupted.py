...
class MasterFlowOrchestrator:
    ...
    # _smart_flow_discovery method extracted to service
    ...
    # _find_related_data_by_timestamp method extracted to service
    ...
    # _find_in_flow_persistence method extracted to service
        ...
        try:
            ...
            if include_details:
                ...
                details = {
                    ...
                    "repair_options": await self.flow_repair_service.generate_repair_options(flow_id, discovered_data),
                    "orphaned_data_summary": await self.flow_repair_service.summarize_orphaned_data(discovered_data)
                }
    ...
    # _retrieve_field_mappings_from_discovered_data method extracted to service
    ) -> List[Dict[str, Any]]:
    ...
    # _find_orphaned_data_for_flow method extracted to service
    ...
    # _generate_repair_options method extracted to service
    ) -> List[Dict[str, Any]]:
    ...
    # _summarize_orphaned_data method extracted to service
