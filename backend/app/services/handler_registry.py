    ...
    def register_handler(
        ...
        if flow_type and phase:
            ...
            if name in self._phase_handlers[flow_type][phase]:
                raise ValueError(
                    f"Phase handler '{name}' already exists for {flow_type}.{phase}"
                )
            ...
            if name in self._flow_handlers[flow_type]:
                raise ValueError(
                    f"Flow handler '{name}' already exists for {flow_type}"
                )
    ...
    async def execute_handler(
        ...
        **kwargs,
        ...
        if not handler:
            ...
            return HandlerResult(success=False, error=f"Handler '{name}' not found")
        ...
        try:
            ...
            return HandlerResult(
                success=False, error=f"Handler execution failed: {str(e)}"
            )
        ...
        async def store_raw_data(
            ...
            **kwargs,
            ...
            try:
                ...
                return HandlerResult(
                    success=True,
                    data={"stored_records": 0, "storage_location": "postgres"},
                    metadata={"timestamp": "2024-01-01T00:00:00Z"},
                )
            except Exception as e:
                return HandlerResult(
                    success=False, error=f"Failed to store raw data: {str(e)}"
                )
        ...
        async def apply_mappings(
            ...
            **kwargs,
            ...
            try:
                ...
                return HandlerResult(
                    success=True, data={"mapped_fields": 0, "mapping_errors": []}
                )
            except Exception as e:
                return HandlerResult(
                    success=False, error=f"Failed to apply mappings: {str(e)}"
                )
        ...
        async def fetch_application_data(
            ...
            **kwargs,
            ...
            try:
                ...
                return HandlerResult(
                    success=True, data={"applications": [], "total_count": len(app_ids)}
                )
            except Exception as e:
                return HandlerResult(
                    success=False, error=f"Failed to fetch application data: {str(e)}"
                )
        ...
        async def create_asset_handler(
            ...
            **kwargs,
            ...
            try:
                ...
                return HandlerResult(
                    success=False, error=f"Failed to create asset: {str(e)}"
                )
        ...
        async def error_notification_handler(
            ...
            **kwargs,
            ...
            try:
                ...
                return HandlerResult(
                    success=True,
                    data={"notification_sent": True, "channels": ["log", "email"]},
                )
            except Exception as e:
                return HandlerResult(
                    success=False, error=f"Failed to send error notification: {str(e)}"
                )
        ...
        async def create_checkpoint_handler(
            ...
            **kwargs,
            ...
            try:
                ...
                return HandlerResult(
                    success=False, error=f"Failed to create checkpoint: {str(e)}"
                )
