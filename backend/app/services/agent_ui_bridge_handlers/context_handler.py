...
class ContextHandler:
    ...
    def update_agent_state(
        self, agent_id: str, state_data: Dict[str, Any], page: str
    ) -> None:
    ...
    def store_learning_experience(self, learning_context: Dict[str, Any]) -> None:
        ...
        experience = {**learning_context, "stored_at": datetime.utcnow().isoformat()}
        ...
        logger.info(
            f"Stored learning experience: {learning_context.get('question_type', 'unknown')}"
        )

    def get_recent_learning_experiences(
        self, limit: int = 50, agent_id: str = None, experience_type: str = None
    ) -> List[Dict[str, Any]]:
        ...
        if experience_type:
            experiences = [
                ...
                if exp.get("question_type") == experience_type
                or exp.get("update_type") == experience_type
            ]
    ...
    def get_agent_coordination_summary(self) -> Dict[str, Any]:
        ...
        for agent_id, state in self.agent_states.items():
            ...
            if last_updated and (
                not page_activity[page]["last_activity"]
                or last_updated > page_activity[page]["last_activity"]
            ):
    ...
    def load_context_data(self, context_data: Dict[str, Any]) -> None:
        ...
        logger.info(
            f"Loaded context: {len(self.cross_page_context)} items, "
