...
class ClassificationHandler:
    ...
    def classify_data_item(
        ...
        try:
            ...
            logger.info(
                f"Classified {data_type} item {item_id} as {classification.value}"
            )
    ...
    def get_classified_data_for_page(
        ...
        page_data = {"good_data": [], "needs_clarification": [], "unusable": []}
    ...
    def update_data_classification(
        ...
        logger.info(
            f"Updated classification for {item_id}: {old_classification.value} -> {new_classification.value}"
        )
    ...
    def clear_classifications(self, page: str = None) -> int:
        ...
        if page:
            self.data_classifications = {
                item_id: item
                for item_id, item in self.data_classifications.items()
                if item.page != page
            }
        else:
