...
class ImportValidator:
            ...
            if actual_incomplete_flows:
                ...
                return {
                    ...
                    "existing_flow": {
                        ...
                        "next_steps": self._get_next_steps_for_phase(first_flow["current_phase"])
                    },
    ...
    async def validate_import_data(self, file_data: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
        ...
        logger.info(f"✅ Data validation completed: {validation_results['record_count']} records, {len(validation_results['issues'])} issues, {len(validation_results['warnings'])} warnings")
        return validation_results