...
class MasterFlowOrchestrator:
    ...
    async def start_flow_with_atomic_sync(self, flow_id: str, flow_type: str) -> Dict[str, Any]:
        ...
        return await self._status_sync_ops.start_flow_with_atomic_sync(flow_id, flow_type)
    ...
    async def pause_flow_with_atomic_sync(self, flow_id: str, flow_type: str, reason: str = "user_requested") -> Dict[str, Any]:
        ...
        return await self._status_sync_ops.pause_flow_with_atomic_sync(flow_id, flow_type, reason)
    ...
    async def resume_flow_with_atomic_sync(self, flow_id: str, flow_type: str) -> Dict[str, Any]:
        ...
        return await self._status_sync_ops.resume_flow_with_atomic_sync(flow_id, flow_type)
    ...
    async def create_flow(
        ...
        return await self._flow_ops.create_flow(flow_type, flow_name, configuration, initial_state, _retry_count)
    ...
    async def execute_phase(
        ...
        return await self._flow_ops.execute_phase(flow_id, phase_name, phase_input, validation_overrides)
    ...
    async def list_flows_by_engagement(self, engagement_id: str, flow_type: Optional[str] = None, limit: int = 50) -> List[Dict[str, Any]]:
        ...
        return await self._status_ops.list_flows_by_engagement(engagement_id, flow_type, limit)
