...
class UnifiedDiscoveryFlow(BaseDiscoveryFlow):
    ...
    async def validate_and_analyze_data(
        self, initial_state: DiscoveryFlowState
    ) -> DiscoveryFlowState:
        """
    ...
    async def perform_field_mapping(
        self, validated_state: DiscoveryFlowState
    ) -> DiscoveryFlowState:
        """
    ...
    async def cleanse_data(
        self, mapped_state: DiscoveryFlowState
    ) -> DiscoveryFlowState:
        """
    ...
    async def build_asset_inventory(
        self, cleansed_state: DiscoveryFlowState
    ) -> DiscoveryFlowState:
        """
    ...
    async def analyze_dependencies(
        self, inventory_state: DiscoveryFlowState
    ) -> DiscoveryFlowState:
        """
        ...
        try:
            ...
            dependency_result = await self.crew_factory.execute_crew(
                ...
                inputs={"assets": self.state.discovered_assets},
            )
            ...
            self.emit_event(
                "phase_completed",
                {
                    ...
                    "dependencies_found": dependency_result.get(
    ...
    async def assess_technical_debt(
        self, analyzed_state: DiscoveryFlowState
    ) -> DiscoveryFlowState:
        """
        ...
        """
        logger.info(
            f"Starting technical debt assessment for flow {analyzed_state.flow_id}"
        )
