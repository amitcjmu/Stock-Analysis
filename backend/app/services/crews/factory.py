...
class CrewFactory:
    ...
    @classmethod
    def validate_crew_inputs(cls, crew_type: str, inputs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if crew_type == "field_mapping":
            ...
            if "raw_data" in inputs:
                ...
                if not isinstance(raw_data, list):
                    ...
                    validation_result["errors"].append("raw_data must contain dictionary objects")
            
            # Check optional fields
            if "source_schema" in inputs and not isinstance(inputs["source_schema"], dict):
                validation_result["warnings"].append("source_schema should be a dictionary")
            
            if "target_fields" in inputs and not isinstance(inputs["target_fields"], list):
