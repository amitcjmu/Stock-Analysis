...
class AgentReasoningEngine:
    ...
    async def analyze_asset_business_value(
        ...
        new_patterns = await self._discover_business_value_patterns(
    ...
    async def analyze_asset_risk_assessment(
        ...
        new_patterns = await self._discover_risk_patterns(
            asset_data, evidence_pieces, agent_name
        )
        discovered_patterns.extend(new_patterns)
    ...
    async def analyze_modernization_potential(
        ...
        evidence_pieces.extend(
            await self._analyze_technology_modernization_evidence(asset_data)
        )
        ...
        new_patterns = await self._discover_modernization_patterns(
            asset_data, evidence_pieces, agent_name
        )
        discovered_patterns.extend(new_patterns)
    ...
    async def _analyze_technology_evidence(
    ...
    async def _analyze_usage_evidence(
        self, asset_data: Dict[str, Any]
    ) -> List[ReasoningEvidence]:
    ...
    async def _analyze_naming_evidence(
        self, asset_data: Dict[str, Any]
    ) -> List[ReasoningEvidence]:
    ...
    async def _analyze_environment_evidence(
        self, asset_data: Dict[str, Any]
    ) -> List[ReasoningEvidence]:
    ...
    async def _analyze_technology_risk_evidence(
        self, asset_data: Dict[str, Any]
    ) -> List[ReasoningEvidence]:
    ...
    async def _analyze_security_evidence(
        self, asset_data: Dict[str, Any]
    ) -> List[ReasoningEvidence]:
    ...
    async def _analyze_compliance_evidence(
        self, asset_data: Dict[str, Any]
    ) -> List[ReasoningEvidence]:
    ...
    async def _analyze_architecture_evidence(
        self, asset_data: Dict[str, Any]
    ) -> List[ReasoningEvidence]:
    ...
    async def _analyze_cloud_readiness_evidence(
        self, asset_data: Dict[str, Any]
    ) -> List[ReasoningEvidence]:
    ...
    async def _analyze_technology_modernization_evidence(
        self, asset_data: Dict[str, Any]
    ) -> List[ReasoningEvidence]:
    ...
    async def _discover_business_value_patterns(
        self,
    ...
    async def _discover_risk_patterns(
        self,
        asset_data: Dict[str, Any],
        evidence: List[ReasoningEvidence],
        agent_name: str,
        ...
        if has_legacy_tech and is_production:
            pattern = {
                ...
                "pattern_logic": {
                    "environment": "production",
                    "technology_stack": {
                        "contains_any": ["java 8", "windows server 2012", "oracle 11g"]
                    },
                },
    ...
    async def _discover_modernization_patterns(
        self,
        asset_data: Dict[str, Any],
        evidence: List[ReasoningEvidence],
        agent_name: str,
    ...
    def _calculate_business_value_reasoning(
        self,
        asset_data: Dict[str, Any],
        evidence: List[ReasoningEvidence],
        ...
        for evidence_piece in evidence:
            if evidence_piece.evidence_type == EvidenceType.ENVIRONMENT_CONTEXT:
                ...
                if (
                    evidence_piece.field_name == "cpu_utilization_percent"
                    and evidence_piece.field_value >= 70
                ):
                    base_score += 2
                    confidence_factors.append(evidence_piece.confidence)
                    reasoning_parts.append(
                        f"High CPU utilization ({evidence_piece.field_value}%) (+2 points)"
                    )
                ...
                if evidence_piece.field_value in ["oracle", "sap", "mainframe"]:
                    ...
                    confidence_factors.append(evidence_piece.confidence)
                    reasoning_parts.append(
                        f"Enterprise technology {evidence_piece.field_value} (+1 point)"
                    )
        ...
        if applied_patterns:
            ...
            reasoning_parts.append(
                f"Applied {len(applied_patterns)} learned patterns (+{len(applied_patterns)} points)"
            )
    ...
    def _calculate_modernization_reasoning(
        self,
        asset_data: Dict[str, Any],
        evidence: List[ReasoningEvidence],
        applied_patterns: List[str],
        ...
        for evidence_piece in evidence:
            if evidence_piece.evidence_type == EvidenceType.TECHNOLOGY_STACK:
                ...
                if any(
                    tech in str(evidence_piece.field_value) for tech in modern_techs
                ):
                    base_score += 20
                    confidence_factors.append(evidence_piece.confidence)
                    reasoning_parts.append(
                        f"Modern technology {evidence_piece.field_value} (+20 points)"
                    )
    ...
    def _generate_business_value_recommendations(
        self, asset_data: Dict[str, Any], evidence: List[ReasoningEvidence], score: int
    ) -> List[str]:
    ...
    def _generate_risk_recommendations(
        ...
        if risk_level == "high":
            ...
            recommendations.append(
                "Low risk asset - standard migration approach appropriate"
            )
    ...
    def _generate_modernization_recommendations(
        ...
        if score >= 80:
            ...
            recommendations.append(
                "Limited modernization potential - consider lift-and-shift approach"
            )
