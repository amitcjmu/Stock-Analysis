...
class CrewManager:
    ...
    def _initialize_dependencies(self):
        ...
        try:
            ...
            if (
                self.crewai_available
                and hasattr(self.settings, "DEEPINFRA_API_KEY")
                and self.settings.DEEPINFRA_API_KEY
                and getattr(self.settings, "CREWAI_ENABLED", True)
            ):
    ...
    def _configure_environment(self):
        ...
        try:
            ...
            if (
                hasattr(self.settings, "DEEPINFRA_API_KEY")
                and self.settings.DEEPINFRA_API_KEY
            ):
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "deepinfra_configured": bool(
                getattr(self.settings, "DEEPINFRA_API_KEY", None)
            ),
