...
This module defines the 22 critical attributes required for accurate 6R strategy decisions.
These attributes are used by the programmatic gap scanner to identify missing data.
"""
...
class CriticalAttributesDefinition:
    ...
    def get_attribute_mapping() -> Dict[str, Any]:
        ...
        Returns:
            ...
            {
                "attribute_name": {
                    "category": "infrastructure|application|business|technical_debt|dependencies",
