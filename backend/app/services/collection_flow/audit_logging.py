    ...
    async def log_event(self, event: AuditEvent) -> None:
        ...
        try:
            ...
            audit_log = SecurityAuditLog(
                ...
                status="success" if event.severity != AuditSeverity.ERROR else "failure",
...
class MonitoringService:
    ...
    async def get_current_metrics(self) -> MonitoringMetrics:
        ...
        try:
            ...
            active_flows = await self._count_flows_by_status(["initialized", "platform_detection", "automated_collection", "gap_analysis", "manual_collection"])
            ...
            success_rate = (completed_flows / finished_flows * 100) if finished_flows > 0 else 0
    ...
    async def get_flow_performance_metrics(
        ...
        try:
            ...
            return {
                ...
                "automation_tier": flow.automation_tier.value if hasattr(flow.automation_tier, 'value') else flow.automation_tier,
    ...
    def _calculate_phase_durations(self, phase_state: Dict[str, Any]) -> Dict[str, float]:
