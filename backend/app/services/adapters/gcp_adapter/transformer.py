...
class GCPDataTransformer:
    ...
    def transform_data(self, raw_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info(
                f"Transformed {len(normalized_data['assets'])} GCP assets to normalized format"
            )
    ...
    def transform_resource_to_asset(
        self, asset_type: str, resource: Dict[str, Any]
        ...
        try:
                ...
                asset.update(
                    {
                        ...
                        "uniform_bucket_level_access": resource.get(
                ...
                asset.update(
                    {
                        ...
                        "current_master_version": resource.get(
            ...
            self.logger.warning(
                f"Failed to transform {asset_type} resource to asset: {str(e)}"
            )
            return None
