...
class GCPMetricsCollector:
    ...
    async def collect_compute_metrics(self, instances: List[Dict], start_time: datetime, end_time: datetime) -> List[Dict]:
                ...
                try:
                    ...
                    for metric_type in COMPUTE_METRICS:
                        try:
                            ...
                            results = self.auth_manager.monitoring_client.list_time_series(request=request)
    ...
    async def collect_sql_metrics(self, instances: List[Dict], start_time: datetime, end_time: datetime) -> List[Dict]:
    ...
    async def collect_function_metrics(self, functions: List[Dict], start_time: datetime, end_time: datetime) -> List[Dict]:
