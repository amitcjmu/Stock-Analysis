...
class UXRecommendationEngine:
    ...
    async def _analyze_performance_optimization(
        ...
        if avg_collection_time > 0 and current_collection_time > avg_collection_time * 1.5:
            recommendations.append(UXRecommendation(
    ...
    async def _analyze_automation_transparency(
        ...
        automation_satisfaction = journey.satisfaction_indicators.get("automation_satisfaction", 0)
