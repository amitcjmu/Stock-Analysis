...
class DiscoveryFlowService:
    ...
    async def get_multi_flow_summary(self, flow_ids: Optional[List[str]] = None) -> Dict[str, Any]:
    ...
    async def get_assets_requiring_review(
        ...
        if flow_id:
            ...
            return [asset for asset in all_assets if (asset.confidence_score or 0) < min_confidence_threshold]
        else:
            # Get all assets requiring review
            return await self.asset_manager.get_assets_requiring_review(min_confidence_threshold)
