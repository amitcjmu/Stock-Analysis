...
class FlowExecutionEngine:
    ...
    def __init__(
        ...
        logger.info(
            f"✅ Flow Execution Engine initialized with modular components for client {context.client_account_id}"
        )
    ...
    async def _initialize_discovery_flow(
        ...
        return await self._initializer._initialize_discovery_flow(
    ...
    async def _initialize_assessment_flow(
        ...
        return await self._initializer._initialize_assessment_flow(
            flow_id, initial_state
        )
