...
class ProgressMonitor(AsyncBaseDiscoveryTool, BaseCollectionTool):
    ...
    async def _build_progress_report(
        ...
        for phase_name, phase_data in phases.items():
            ...
            phase_metric = self._build_phase_metrics(
                phase_name, phase_data, metrics_type
            )
    ...
    def _build_phase_metrics(
        self, phase_name: str, phase_data: Dict[str, Any], metrics_type: str
    ) -> Dict[str, Any]:
    ...
    def _build_performance_summary(
        self, flow_state: Dict[str, Any], phase_metrics: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
    ...
    def _add_progress_alerts(
        self, progress: Dict[str, Any], flow_state: Dict[str, Any]
    ):
