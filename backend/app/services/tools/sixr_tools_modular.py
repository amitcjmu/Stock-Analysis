...
def run_cmdb_analysis_tool(application_data: Dict[str, Any], analysis_focus: str = "all") -> str:
...
def run_question_generation_tool(information_gaps: List[str], 
...
def run_code_analysis_tool(file_content: str, file_type: str, analysis_type: str = "complexity") -> str:
    """Run code analysis tool and return JSON string."""
    try:
        result = tool_manager.execute_code_analysis(file_content, file_type, analysis_type)
        import json
        return json.dumps(result, indent=2)
    except Exception as e:
...
def run_recommendation_validation_tool(recommendation: Dict[str, Any],
                                     application_context: Dict[str, Any],
...
try:
    ...
    class ParameterScoringInput(BaseModel):
        ...
        parameters: Dict[str, float] = Field(..., description="6R analysis parameters to score")
        strategy: str = Field(..., description="Target migration strategy for scoring alignment")
    ...
    class ParameterScoringTool(BaseTool):
        ...
        description: str = "Score 6R analysis parameters for alignment with migration strategies"
    ...
    class QuestionGenerationInput(BaseModel):
        ...
        application_context: Dict[str, Any] = Field(..., description="Application context information")
        current_parameters: Dict[str, Any] = Field(default_factory=dict, description="Current parameter values")
    ...
    class QuestionGenerationTool(BaseTool):
        ...
        description: str = "Generate qualifying questions to fill information gaps in 6R analysis"
        ...
        def _run(self, information_gaps: List[str], application_context: Dict[str, Any], 
                current_parameters: Dict[str, Any] = None) -> str:
            """Generate qualifying questions based on information gaps."""
            if current_parameters is None:
                current_parameters = {}
            return run_question_generation_tool(information_gaps, application_context, current_parameters)
    ...
    class ValidationInput(BaseModel):
        ...
        context: Dict[str, Any] = Field(..., description="Application and business context")
        constraints: Dict[str, Any] = Field(default_factory=dict, description="Business constraints and requirements")
    ...
    class RecommendationValidationTool(BaseTool):
        ...
        def _run(self, recommendation: Dict[str, Any], context: Dict[str, Any], 
                constraints: Dict[str, Any] = None) -> str:
            """Validate recommendation against constraints."""
            if constraints is None:
                constraints = {}
            return run_recommendation_validation_tool(recommendation, context, constraints)
