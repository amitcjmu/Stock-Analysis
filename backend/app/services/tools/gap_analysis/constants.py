...
VALIDATION_RULES = {
    ...
    "environment": lambda v: isinstance(v, str)
    and v.lower() in ["dev", "test", "qa", "staging", "prod", "production"],
    "os_type": lambda v: isinstance(v, str)
    and any(os in v.lower() for os in ["windows", "linux", "unix", "aix", "solaris"]),
}
