...
class PriorityRankerTool(AsyncBaseDiscoveryTool):
    ...
    description: str = (
        "Rank and prioritize gaps based on business impact and collection feasibility"
    )
    ...
    async def arun(
        self, gaps: List[Dict[str, Any]], ranking_criteria: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            for gap in gaps:
                scores = {
                    ...
                    "strategy_alignment": self._score_strategy_alignment(
                        gap, ranking_criteria
                    ),
                ...
                total_score = sum(
                    scores[criteria] * weights[criteria] for criteria in scores
                )
    ...
    def _score_business_impact(self, gap: Dict[str, Any]) -> float:
        ...
        base_scores = {"critical": 100, "high": 80, "medium": 50, "low": 20}
    ...
    def _score_strategy_alignment(
        self, gap: Dict[str, Any], criteria: Dict[str, Any]
    ) -> float:
    ...
    def _score_feasibility(self, gap: Dict[str, Any]) -> float:
        ...
        feasibility_scores = {"easy": 100, "medium": 70, "hard": 40, "very_hard": 20}
