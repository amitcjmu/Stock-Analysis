...
class AgentServiceLayer:
    ...
    def __init__(
        self, client_account_id: str, engagement_id: str, user_id: Optional[str] = None
    ):
    ...
    def get_flow_status(self, flow_id: str) -> Dict[str, Any]:
        ...
        return self._execute_with_tracking(
            "get_flow_status", self.flow_handler.get_flow_status, flow_id
        )
    ...
    def get_active_flows(self) -> List[Dict[str, Any]]:
        ...
        return self._execute_with_tracking(
            "get_active_flows", self.flow_handler.get_active_flows
        )
    ...
    def get_import_data(
        self, flow_id: str, limit: Optional[int] = None
    ) -> Dict[str, Any]:
        """Get imported data for a flow"""
        return self._execute_with_tracking(
            "get_import_data", self.data_handler.get_import_data, flow_id, limit
        )

    def get_field_mappings(self, flow_id: str) -> Dict[str, Any]:
        """Get field mappings for a flow"""
        return self._execute_with_tracking(
            "get_field_mappings", self.data_handler.get_field_mappings, flow_id
        )

    def validate_mappings(
        self, flow_id: str, mappings: Dict[str, Any]
    ) -> Dict[str, Any]:
        """Validate field mappings"""
        return self._execute_with_tracking(
            "validate_mappings", self.data_handler.validate_mappings, flow_id, mappings
        )

    def get_cleansing_results(self, flow_id: str) -> Dict[str, Any]:
        """Get data cleansing results"""
        return self._execute_with_tracking(
            "get_cleansing_results", self.data_handler.get_cleansing_results, flow_id
        )

    def get_validation_issues(self, flow_id: str) -> List[Dict[str, Any]]:
        """Get validation issues for a flow"""
        return self._execute_with_tracking(
            "get_validation_issues", self.data_handler.get_validation_issues, flow_id
        )
    ...
    def get_asset_dependencies(self, flow_id: str) -> Dict[str, Any]:
        ...
        return self._execute_with_tracking(
            "get_asset_dependencies", self.asset_handler.get_asset_dependencies, flow_id
        )

    def get_tech_debt_analysis(self, flow_id: str) -> Dict[str, Any]:
        """Get technical debt analysis for a flow"""
        return self._execute_with_tracking(
            "get_tech_debt_analysis", self.asset_handler.get_tech_debt_analysis, flow_id
        )

    def validate_asset_data(self, asset_id: str) -> Dict[str, Any]:
        """Validate asset data quality"""
        return self._execute_with_tracking(
            "validate_asset_data", self.asset_handler.validate_asset_data, asset_id
        )
    ...
    def _execute_with_tracking(
        self, method_name: str, async_method, *args, **kwargs
    ) -> Any:
        ...
        try:
            ...
            future = self.executor.submit(asyncio.run, async_method(*args, **kwargs))
