...
try:
    ...
    logging.warning("LangChain not available. DeepInfra LLM will use basic implementation.")
...
class DeepInfraLlama4LLM(LLM if LANGCHAIN_AVAILABLE else object):
    ...
    base_url: str = Field(default="https://api.deepinfra.com/v1/openai/chat/completions")
    ...
    def __init__(self, **kwargs):
        ...
        self.base_url = kwargs.get('base_url', "https://api.deepinfra.com/v1/openai/chat/completions")
        ...
        self.reasoning_effort = kwargs.get('reasoning_effort', "none")  # Disable reasoning/thinking
        ...
        **kwargs: Any,
        ...
        try:
            ...
            if "choices" in result and len(result["choices"]) > 0:
                ...
                if "usage" in result:
                    usage = result["usage"]
                    logger.info(f"DeepInfra API call completed: "
...
def create_deepinfra_llm(**kwargs) -> DeepInfraLlama4LLM:
    ...
    config = {
        ...
        'base_url': kwargs.get('base_url', "https://api.deepinfra.com/v1/openai/chat/completions"),
