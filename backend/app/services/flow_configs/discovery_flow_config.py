...
def get_discovery_flow_config() -> FlowTypeConfig:
    ...
    data_import_phase = PhaseConfig(
        ...
        crew_config={
            ...
            "validation_mapping": {
                "required_fields": ["file_type", "security_status", "asset_inventory_suitable"],
                "success_criteria": {
    ...
    data_cleansing_phase = PhaseConfig(
        ...
        crew_config={
            ...
            "validation_mapping": {
                "required_fields": ["cleaned_data", "quality_metrics", "enrichment_summary"],
                "success_criteria": {
    ...
    asset_inventory_phase = PhaseConfig(
        ...
        crew_config={
            ...
            "validation_mapping": {
                "required_fields": ["asset_inventory", "asset_relationships", "classification_summary"],
                "success_criteria": {
