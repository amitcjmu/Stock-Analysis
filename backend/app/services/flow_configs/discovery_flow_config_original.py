...
from app.services.flow_configs.discovery_phase_constants import (
    ALL_PHASES,
    PHASE_DEPENDENCIES,
    PHASE_SEQUENCE,
)
...
def get_discovery_flow_config() -> FlowTypeConfig:
    ...
    # Import phase configurations from constants
    # All phases are now defined in discovery_phase_constants.py
        name="data_import",
    ...
    asset_inventory_phase = PhaseConfig(
        ...
        crew_config={
            ...
            # "crew_factory": "create_inventory_building_crew",  # REMOVED: Now uses persistent agents
            "input_mapping": {
