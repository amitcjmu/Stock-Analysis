...
def get_collection_flow_config() -> FlowTypeConfig:
    ...
    gap_analysis_phase = PhaseConfig(
        ...
        optional_inputs=["custom_requirements", "priority_fields", "quality_thresholds"],
    ...
    manual_collection_phase = PhaseConfig(
        ...
        optional_inputs=["respondent_assignments", "collection_deadlines", "response_format"],
    ...
    synthesis_phase = PhaseConfig(
        ...
        optional_inputs=["synthesis_preferences", "output_format", "export_requirements"],
    ...
    capabilities = FlowCapabilities(
        ...
        required_permissions=["collection.read", "collection.write", "collection.execute", "adapter.execute"]
    )
    ...
    collection_config = FlowTypeConfig(
        ...
        tags=["collection", "automation", "adcs", "multi-tier", "data-quality", "ai-powered"]
    )
