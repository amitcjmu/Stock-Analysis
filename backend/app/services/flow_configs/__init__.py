...
from .discovery_handlers import (
    ...
    asset_inventory,  # Re-added: asset inventory handler with executor implementation
...
class FlowConfigurationManager:
    ...
    def _register_all_handlers(self, results: Dict[str, Any]) -> None:
        ...
        handlers = {
            ...
            "asset_inventory": asset_inventory,  # Re-added: asset inventory handler with executor implementation
