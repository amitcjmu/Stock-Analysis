    ...
    **kwargs
    ...
    try:
        ...
        finalization_result = {
            ...
            "ready_for_assessment": summary_report["summary"]["total_assets_discovered"] > 0
        }
...
async def discovery_error_handler(
    ...
    **kwargs
    ...
    try:
        ...
        recovery_action = _determine_recovery_action(error_classification, phase, flow_state)
        ...
        error_report = {
            ...
            "requires_manual_intervention": error_classification.get("requires_manual", False)
        }
...
async def asset_creation_completion(
    ...
    **kwargs
    ...
    try:
        ...
        logger.info(f"Asset creation completed for flow {flow_id}: {len(assets)} assets created")
    ...
    **kwargs
    ...
    try:
        ...
        return {
            ...
            "flow_id": flow_id,
            "phase": phase_name,
            "records_imported": len(imported_data) if isinstance(imported_data, list) else 0,
...
async def _send_error_alerts(flow_id: str, error_report: Dict[str, Any]) -> None:
    """Send error alerts"""
    logger.warning(f"Sending error alerts for flow {flow_id}: {error_report['error_type']}")
