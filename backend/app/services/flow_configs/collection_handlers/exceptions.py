...
class CollectionFlowError(Exception):
    ...
    def __init__(self, message: str, flow_id: str = None, context: dict = None):
...
class AdapterError(CollectionFlowError):
    ...
    def __init__(
        self, message: str, adapter_name: str = None, platform: str = None, **kwargs
    ):
...
class CrewAIExecutionError(CollectionFlowError):
    ...
    def __init__(self, message: str, crew_error: Exception = None, **kwargs):
...
class WriteBackError(CollectionFlowError):
    ...
    def __init__(self, message: str, asset_ids: list = None, **kwargs):
...
class RollbackError(CollectionFlowError):
    ...
    def __init__(self, message: str, rollback_phase: str = None, **kwargs):
...
class ConfigurationError(CollectionFlowError):
    ...
    def __init__(self, message: str, config_errors: list = None, **kwargs):
...
def create_error_context(
    operation: str, phase: str = None, platform: str = None, **kwargs
) -> dict:
