...
class WorkflowMonitoringService:
    ...
    async def start_workflow_monitoring(
        ...
        try:
            ...
            await self.progress_tracker.initialize_workflow_progress(workflow_id, custom_milestones or [])
    ...
    async def get_workflow_progress(
        ...
        return await self.progress_tracker.get_workflow_progress(workflow_id, include_details)
    ...
    async def get_health_status(
        ...
        return await self.health_monitor.get_health_status(workflow_id, component_filter)
    ...
    async def get_active_alerts(
        ...
        return await self.alert_manager.get_active_alerts(workflow_id, severity_filter, limit)
    ...
    async def create_custom_alert(
        ...
        return await self.alert_manager.create_custom_alert(
            name, description, condition, threshold, severity,
            evaluation_window_ms, workflow_id, self.context.user_id
        )
