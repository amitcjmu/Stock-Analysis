...
class ConfigRecommendationGenerator:
    ...
    async def _generate_quality_threshold_optimization(
        ...
        if min_quality_score > 0.85 or business_requirements.get("compliance_required", False):
            return WorkflowRecommendation(
                ...
                alternatives=[],
                metadata={"compliance_required": business_requirements.get("compliance_required", False)}
            )
