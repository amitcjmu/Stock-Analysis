...
class TierRecommendationGenerator:
    ...
    async def _analyze_tier_upgrade_potential(
        ...
        if current_tier == AutomationTier.TIER_3 and complexity_level in ["moderate", "complex", "enterprise"]:
            ...
            if "quality" in optimization_goals or "performance" in optimization_goals:
                ...
                confidence = 0.8
        elif current_tier == AutomationTier.TIER_2 and complexity_level in ["complex", "enterprise"]:
            # Consider upgrade to Tier 1
            if "quality" in optimization_goals and environment_analysis.get("custom_requirements", 0) > 3:
                upgrade_viable = True
        ...
        for pattern in patterns:
            if pattern.pattern_type == "automation_tier" and pattern.conditions.get("automation_tier") == recommended_tier:
        ...
        return {
            ...
            "risks": {
                ...
                "risk_factors": ["Implementation complexity", "Learning curve"] if upgrade_viable else []
            }
        }
