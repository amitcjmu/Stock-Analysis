...
class CrewExecutionHandler:
    ...
    def __init__(self, crewai_service):
        ...
        self.discovery_integration_executor = DiscoveryIntegrationExecutor(
            crewai_service
        )
    ...
    def execute_app_server_dependency_crew(self, state) -> Dict[str, Any]:
        ...
        return self.dependency_analysis_executor.execute_app_server_dependency_crew(
            state
        )
    ...
    def _persist_discovery_data_to_database(self, state) -> Dict[str, Any]:
        ...
        return self.discovery_integration_executor._persist_discovery_data_to_database(
            state
        )

    async def _async_persist_discovery_data(self, state) -> Dict[str, Any]:
        """Async method to persist discovery data to database"""
        return await self.discovery_integration_executor._async_persist_discovery_data(
            state
        )
