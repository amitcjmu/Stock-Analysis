...
class CallbackHandlerIntegration:
    ...
    def create_callback_handler(
        ...
        logger.info(
            f"✅ Created callback handler for flow {flow_id} with monitoring context"
        )
