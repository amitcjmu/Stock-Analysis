...
class EnhancedErrorHandler:
    ...
    def __init__(self):
        ...
        self.phase_retry_configs = {
            ...
            "field_mapping": RetryConfig(
                max_retries=5, base_delay=3.0, max_delay=120.0
            ),
        ...
        **kwargs,
        ...
        try:
            ...
            strategy = self._determine_recovery_strategy(
                phase_name, error, error_category, state
            )

            # Execute recovery strategy
            result = await self._execute_recovery_strategy(
                strategy, phase_name, error, state, phase_func, *args, **kwargs
            )
    ...
    def _log_error(
        self, phase_name: str, error: Exception, state: Any
    ) -> Dict[str, Any]:
        """Log error details"""
        error_info = {
            "phase": phase_name,
    ...
    def _determine_recovery_strategy(
        ...
        max_retries = self.phase_retry_configs.get(
            phase_name, RetryConfig()
        ).max_retries
    ...
    async def _execute_recovery_strategy(
        ...
        **kwargs,
        ...
        if strategy == RecoveryStrategy.RETRY_WITH_BACKOFF:
            ...
            # Update retry count
            self.recovery_attempts[retry_key] = (
                self.recovery_attempts.get(retry_key, 0) + 1
            )
            ...
            try:
                ...
                result = await retry_with_backoff(
                    phase_func, *args, config=retry_config, **kwargs
                )
    ...
    def _create_partial_result(self, phase_name: str, state: Any) -> Dict[str, Any]:
        ...
        if phase_name == "dependency_analysis":
            ...
            return {"data": [], "complete": False, "partial_result": True}
    ...
    def get_error_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "errors_by_phase": {
                phase: len(errors) for phase, errors in errors_by_phase.items()
            },
    ...
    async def handle_critical_flow_error(
        self, flow_id: str, error: Exception, state: Any
    ) -> Dict[str, Any]:
        """
        ...
        return {
            ...
            "recovery_options": (
                ["restart_from_checkpoint", "restart_flow", "manual_intervention"]
                if can_recover
