...
class FlowExecutionHandler:
    ...
    def execute_data_cleansing_crew(self, field_mappings: Dict[str, Any], raw_data: List[Dict[str, Any]], 
        ...
        try:
            ...
            logger.info(f"✅ Data Cleansing Crew completed - processed {len(result.get('cleaned_data', []))} records")
    ...
    def execute_inventory_building_crew(self, cleaned_data: List[Dict[str, Any]], 
                                      field_mappings: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    def execute_app_server_dependency_crew(self, asset_inventory: Dict[str, Any], 
                                         context: Any) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "hosting_relationships": len(dependencies.get("hosting_relationships", [])),
    ...
    def execute_app_app_dependency_crew(self, asset_inventory: Dict[str, Any], 
        ...
        try:
            ...
            return {
                ...
                "integration_relationships": len(dependencies.get("communication_patterns", [])),
    ...
    def execute_technical_debt_crew(self, asset_inventory: Dict[str, Any], 
                                  dependencies: Dict[str, Any], context: Any) -> Dict[str, Any]:
        ...
        try:
            ...
            discovery_summary = {
                ...
                "cleaned_data_summary": {
                    ...
                    "quality_score": getattr(state, 'data_quality_metrics', {}).get("overall_score", 0.0)
                },
                "asset_inventory_summary": {
                    "servers": len(getattr(state, 'asset_inventory', {}).get("servers", [])),
                    "applications": len(getattr(state, 'asset_inventory', {}).get("applications", [])),
                    "devices": len(getattr(state, 'asset_inventory', {}).get("devices", []))
                },
                "dependency_analysis": {
                    "app_server_relationships": len(getattr(state, 'app_server_dependencies', {}).get("hosting_relationships", [])),
                    "app_app_integrations": len(getattr(state, 'app_app_dependencies', {}).get("communication_patterns", []))
                },
    ...
    def validate_phase_success(self, phase_name: str, state: Any) -> bool:
        ...
        try:
            ...
            if phase_name == "field_mapping":
                ...
                validation_passed = field_mappings.get("validation_results", {}).get("valid", False)
                ...
                standardization = data_quality_metrics.get("standardization_complete", False)
    ...
    def update_crew_with_validation(self, phase_name: str, result: Dict[str, Any], state: Any) -> Dict[str, Any]:
        ...
        try:
            ...
            if phase_name == "data_cleansing":
                ...
                state.app_server_dependencies = result.get("app_server_dependencies", {})
            elif phase_name == "app_app_dependencies":
                state.app_app_dependencies = result.get("app_app_dependencies", {})
            elif phase_name == "technical_debt":
                state.technical_debt_assessment = result.get("technical_debt_assessment", {})
        ...
        try:
            ...
            validation = {
                "field_mapping": {
                    ...
                    "status": "completed" if field_mappings.get("mappings") else "incomplete"
                },
                "data_cleansing": {
                ...
                "app_server_dependencies": {
                    ...
                    "relationship_count": len(app_server_dependencies.get("hosting_relationships", [])),
                    "status": "completed" if app_server_dependencies else "incomplete"
                },
                "app_app_dependencies": {
                    "completed": bool(app_app_dependencies),
                    "integration_count": len(app_app_dependencies.get("communication_patterns", [])),
                ...
                "technical_debt": {
                    ...
                    "status": "completed" if technical_debt_assessment else "incomplete"
                }
            }
