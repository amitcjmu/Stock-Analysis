...
class ManualCollectionHandler:
    ...
    async def manual_collection(self, state: CollectionFlowState, config: Dict[str, Any],
                               questionnaire_result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Validate responses
            validated_responses = await self.services.validation_service.validate_questionnaire_responses(
                responses=responses,
