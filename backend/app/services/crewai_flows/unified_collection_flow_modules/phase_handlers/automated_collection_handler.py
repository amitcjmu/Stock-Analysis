...
class AutomatedCollectionHandler:
    ...
    async def automated_collection(self, state: CollectionFlowState, config: Dict[str, Any],
                                  platform_result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            crew = create_automated_collection_crew(
                ...
                tier_assessments=state.phase_results.get("platform_detection", {}).get("tier_analysis", {}),
                context={
            ...
            # Transform data
            transformed_data = await self.services.data_transformation.transform_collected_data(
                raw_data=collected_data,
                platforms=detected_platforms,
                normalization_rules=config.get("client_requirements", {}).get("normalization_rules", {})
            )
            ...
            quality_scores = await self.services.quality_assessment.assess_collection_quality(
