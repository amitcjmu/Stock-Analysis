...
class PlatformDetectionHandler:
    ...
    def __init__(self, flow_context, state_manager, services, unified_flow_management, crewai_service):
    ...
    async def detect_platforms(self, state: CollectionFlowState, config: Dict[str, Any], 
        ...
        try:
            ...
            if requires_user_approval("platform_detection", config.get("client_requirements", {})):
