...
class FlowStateRecovery:
    ...
    async def recover_failed_flow(self, flow_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if checkpoint_data:
                ...
                logger.info(f"🔧 No checkpoints available, attempting state repair for {flow_id}")
    ...
    async def handle_corrupted_state(self, flow_id: str) -> None:
        ...
        try:
            ...
            await self._notify_administrators(flow_id, f'corrupted_state_handling_failed: {e}')
    
    async def _find_last_good_checkpoint(self, flow_id: str) -> Optional[Dict[str, Any]]:
    ...
    async def _repair_corrupted_state(self, corrupted_state: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            list_fields = ['errors', 'warnings', 'agent_insights', 'user_clarifications', 'workflow_log']
    ...
    async def _reset_to_initial_state(self, flow_id: str, original_state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _archive_corrupted_state(self, flow_id: str, corrupted_state: Dict[str, Any]):
    ...
    async def get_recovery_status(self, flow_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'recovery_history': {
                    'checkpoints_available': len(persistence_data.get('checkpoints', [])),
                ...
                'validation_status': self.validator.validate_complete_state(current_state)
            }
