...
class ConfidenceCalculator:
    ...
    @staticmethod
    def weighted_average(factors: Dict[str, float], weights: Dict[str, float] = None) -> float:
        """
    ...
    def calculate_threshold(
        ...
        adjusted = threshold + risk_adjustment + quality_adjustment + complexity_adjustment
...
class DecisionUtils:
    ...
    def assess_completeness(phase: str, state: UnifiedDiscoveryFlowState) -> float:
        ...
        phase_completion = DecisionUtils.get_state_attribute(state, 'phase_completion', {})
    ...
    def identify_critical_fields(state: UnifiedDiscoveryFlowState) -> List[str]:
        ...
        critical_fields = []
        field_names = list(raw_data[0].keys()) if raw_data and isinstance(raw_data[0], dict) else []
