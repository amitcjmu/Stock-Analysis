...
class OptimizedCrewBase:
    ...
    def __init__(
        ...
        logger.info(f"🚀 Optimized crew base initialized with memory={enable_memory}, caching={enable_caching}, parallel={enable_parallel}")
    ...
    async def _initialize_agent_memory(self, agent: Agent, role: str):
        ...
        try:
            ...
            if past_experiences:
                ...
                logger.info(f"Loaded {len(past_experiences)} past experiences for {role}")
    ...
    def create_optimized_task(
        ...
        **kwargs
        ...
        task_config = {
            ...
            "async_execution": self.enable_parallel and kwargs.get("async_execution", False),
        ...
        async def monitored_kickoff(*args, **kwargs):
            ...
            try:
                ...
                if self.enable_caching and result:
                    await response_optimizer.cache.set("crew_execution", {"key": cache_key}, result)
    ...
    def _update_performance_metrics(self, duration: float, success: bool = True):
        ...
        logger.info(f"{status} Task completed in {duration:.2f}s (avg: {self.performance_metrics['avg_task_duration']:.2f}s)")
