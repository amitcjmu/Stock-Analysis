...
class TechnicalDebtCrew:
    ...
    def create_tasks(
        self, agents, asset_inventory: Dict[str, Any], dependencies: Dict[str, Any]
    ):
    ...
    def create_crew(
        self, asset_inventory: Dict[str, Any], dependencies: Dict[str, Any]
    ):
        ...
        logger.info(
            f"Creating Technical Debt Crew with {process.name if hasattr(process, 'name') else 'sequential'} process"
        )
        logger.info(
...
def create_technical_debt_crew(
    crewai_service,
