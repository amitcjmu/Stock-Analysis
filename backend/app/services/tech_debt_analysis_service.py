...
class TechDebtAnalysisService:
    ...
    async def analyze_tech_debt(self, assets: List[Dict[str, Any]], stakeholder_context: Optional[Dict[str, Any]] = None, migration_timeline: Optional[str] = None) -> Dict[str, Any]:
        ...
        business_risk = await self.risk_handler.assess_business_risk(technical_analysis, stakeholder_context, migration_timeline)
