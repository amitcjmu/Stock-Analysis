...
class AssetService:
    ...
    def __init__(
        ...
        client_account_id = str(self.context_info.get("client_account_id")) if self.context_info.get("client_account_id") else None
        engagement_id = str(self.context_info.get("engagement_id")) if self.context_info.get("engagement_id") else None
    ...
    async def create_asset(self, asset_data: Dict[str, Any]) -> Optional[Asset]:
        ...
        try:
            ...
            create_method = self.repository.create_no_commit if self._request_context else self.repository.create
