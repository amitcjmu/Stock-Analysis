        ...
        async with AsyncSessionLocal() as db:
            ...
            try:
                ...
                if row:
                    ...
                    metrics["last_flow_created"] = row.last_created.isoformat() if row.last_created else None
...
if FASTAPI_AVAILABLE:
    ...
    async def assessment_health_check():
        ...
        unhealthy_checks = [k for k, v in health_status["checks"].items() if v.startswith("unhealthy")]
        if unhealthy_checks:
