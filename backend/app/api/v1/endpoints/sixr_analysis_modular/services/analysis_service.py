...
class AnalysisService:
        ...
        try:
            ...
            async with AsyncSessionLocal() as db:
                try:
                    ...
                    recommendation_data = self.decision_engine.analyze_parameters(param_obj, application_data[0] if application_data else None)
    ...
    async def run_parameter_update_analysis(self, analysis_id: int, parameters: Dict[str, Any], user: str):
        ...
        try:
            async with AsyncSessionLocal() as db:
                try:
                    ...
                    recommendation_data = self.decision_engine.analyze_parameters(param_obj, app_context)
    ...
    async def process_question_responses(self, analysis_id: int, responses: List[Dict[str, Any]], user: str):
            ...
            async with AsyncSessionLocal() as db:
                try:
                    ...
                    if current_params:
                        ...
                        recommendation_data = self.decision_engine.analyze_parameters(param_obj, question_context)
