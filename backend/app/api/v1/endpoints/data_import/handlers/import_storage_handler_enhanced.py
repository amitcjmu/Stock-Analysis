...
@router.post(
    ...
    **Multi-tenant Headers Required**: X-Client-Account-ID, X-Engagement-ID
    ...
    responses={
        ...
        500: {"description": "Internal Server Error", "model": DataImportErrorResponse},
    },
    tags=["Data Import"],
)
            ...
            "content": {
                "application/json": {
                    "example": {
                        ...
                        "data": [],
                        "import_metadata": {"no_imports_exist": True},
                    }
                }
            },
        },
...
async def get_import_status(
    import_id: str, db: AsyncSession = Depends(get_db)
) -> ImportStatusResponse:
    ...
    try:
        ...
        return ImportStatusResponse(success=True, import_status=status)
