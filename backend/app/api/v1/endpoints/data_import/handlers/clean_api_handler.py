...
async def clean_data_import(
    ...
    """
    logger.info(f"🧹 Clean data import initiated for context: {context.client_account_id}")
...
async def handle_data_cleaning_request(
    ...
    try:
        ...
        cleaning_result = {
            ...
            "cleaning_rules_applied": len(request.cleaning_rules) if hasattr(request, 'cleaning_rules') else 0
        }
