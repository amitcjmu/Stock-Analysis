...
async def get_attribute_recommendations(
    ...
    try:
        recommendations = await learning_service.get_attribute_recommendations(attribute_name)
        return recommendations
        
    except Exception as e:
        logger.error(f"Error getting attribute recommendations: {e}")
        raise HTTPException(status_code=500, detail="Failed to get attribute recommendations")
    ...
    try:
        ...
        return {
            ...
            "accuracy_summary": {
                ...
                "correct_predictions": insights["accuracy_metrics"]["correct_predictions"],
                "incorrect_predictions": insights["accuracy_metrics"]["incorrect_predictions"]
            },
