...
def validate_data_type_compatibility(source_type: str, target_type: str) -> Dict[str, Any]:
    ...
    conversion_info = source_conversions.get(target_type, {"compatible": False, "transformation": None})
...
def analyze_field_patterns(field_name: str, sample_values: List[Any]) -> Dict[str, Any]:
    ...
    analysis["suggested_targets"] = suggest_target_field_by_type(analysis["inferred_type"])
