...
def get_field_mappings(
    ...
    workflow_state = workflow_state_service.get_workflow_state(db, session_id)
    if not workflow_state or "data_import_id" not in workflow_state.state_details:
        raise HTTPException(status_code=404, detail="No active data import found for this session.")
