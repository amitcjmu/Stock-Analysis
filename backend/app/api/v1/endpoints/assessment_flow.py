...
async def get_application_components(
    ...
    try:
        ...
        logger.error(f"Failed to get application components: {str(e)}")
...
async def update_application_components(
    ...
    try:
        ...
        logger.error(f"Failed to update application components: {str(e)}")
...
async def get_sixr_decisions(
    ...
    try:
        ...
        logger.error(f"Failed to get 6R decisions: {str(e)}")
...
async def update_sixr_decision(
    ...
    try:
        ...
        logger.error(f"Failed to update 6R decision: {str(e)}")
...
async def finalize_assessment(
    ...
    try:
        ...
        logger.error(f"Failed to finalize assessment: {str(e)}")
