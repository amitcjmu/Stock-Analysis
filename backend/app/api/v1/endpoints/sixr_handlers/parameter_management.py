...
class ParameterManagementHandler:
    ...
    def _validate_parameter_values(self, parameter_updates: Dict[str, Any]) -> list:
        ...
        numeric_params = [
            'business_value', 'technical_complexity', 'migration_urgency',
        ...
        for param_name, param_value in parameter_updates.items():
            if param_name in numeric_params:
                ...
                valid_types = [
                    'web_application', 'database', 'legacy_system',
                    'microservice', 'monolith', 'api_service', 'batch_processing'
                ]
    ...
    def _convert_responses_to_parameters(self, responses: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for question_id, response in responses.items():
            ...
            elif 'cost' in str(response).lower() and 'sensitive' in str(response).lower():
                parameter_updates['cost_sensitivity'] = 4
        
        return parameter_updates
    
    async def _build_analysis_response(self, analysis, db: AsyncSession) -> Dict[str, Any]:
    ...
    # Fallback methods
    def _fallback_update_parameters(self, analysis_id: int, request: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _fallback_submit_questions(self, analysis_id: int, request: Dict[str, Any]) -> Dict[str, Any]:
