...
async def create_sixr_analysis(
    ...
    try:
        ...
        result = await analysis_handler.create_analysis(request_body, background_tasks, db)
        return result
...
async def update_sixr_parameters(
    ...
    try:
        request_body = await request.json()
        result = await parameter_handler.update_parameters(analysis_id, request_body, db)
        return result
...
async def submit_qualifying_questions(
    ...
    try:
        request_body = await request.json()
        result = await parameter_handler.submit_qualifying_questions(analysis_id, request_body, db)
        return result
...
async def create_bulk_sixr_analysis(
    ...
    try:
        request_body = await request.json()
        result = await analysis_handler.create_bulk_analysis(request_body, background_tasks, db)
        return result
