        ...
        if not questionnaires:
            ...
            if flow.collection_config and flow.collection_config.get("selected_application_ids"):
                ...
                if selected_app_ids:
                    ...
                    if selected_asset:
                        selected_application_name = selected_asset.name or selected_asset.application_name
                        logger.info(f"Pre-populating questionnaire with application: {selected_application_name} (ID: {selected_application_id})")
                    else:
                        logger.warning(f"Selected application {selected_application_id} not found in asset inventory")
            ...
            bootstrap_questionnaire = AdaptiveQuestionnaireResponse(
                ...
                } if selected_application_name else {},
