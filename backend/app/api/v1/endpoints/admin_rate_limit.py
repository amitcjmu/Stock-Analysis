...
async def cleanup_inactive_clients(
    inactive_hours: int = Query(24, ge=1, le=168, description="Hours of inactivity before cleanup"),
    current_user: User = Depends(require_admin)
) -> Dict[str, Any]:
    """
...
async def update_rate_limit_config(
    user_type: str = Query(..., description="User type: anonymous, authenticated, testing, development"),
    ...
    burst_capacity: Optional[int] = Query(None, ge=0, description="Additional burst capacity"),
    current_user: User = Depends(require_admin)
) -> Dict[str, Any]:
    """
