...
class AssetUtilsHandler:
    ...
    def transform_asset_for_frontend(self, asset: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            transformed = {
                ...
                "criticality": self.map_criticality(asset.get('status') or asset.get('criticality', 'Medium')),
                ...
                "technology_stack": asset.get('technology_stack') or self.build_tech_stack_from_asset(asset),
    ...
    def map_criticality(self, status: str) -> str:
        ...
        try:
            ...
            if any(indicator in status_lower for indicator in [
                'critical', 'high', 'production', 'prod', 'tier1', 'tier-1', 
                'mission-critical', 'business-critical', 'essential', 'vital'
            ]):
                return "High"
            
            # Low criticality indicators
            elif any(indicator in status_lower for indicator in [
                'low', 'tier3', 'tier-3', 'non-critical', 'optional', 
    ...
    def standardize_os_family(self, os_name: str) -> str:
        ...
        try:
            ...
            # Linux family
            elif any(linux in os_lower for linux in [
                'linux', 'ubuntu', 'redhat', 'rhel', 'centos', 'debian', 
                'suse', 'fedora', 'mint', 'kali', 'arch'
            ]):
                return "Linux"
            
            # Unix family
            elif any(unix in os_lower for unix in [
                'unix', 'aix', 'solaris', 'hpux', 'hp-ux'
            ]):
                return "Unix"
            ...
            # BSD family
            elif any(bsd in os_lower for bsd in ['bsd', 'freebsd', 'openbsd', 'netbsd']):
                return "BSD"
    ...
    def extract_numeric_value(self, value) -> Optional[int]:
        ...
        try:
            ...
            if isinstance(value, str):
                ...
                if not value_clean or value_clean.lower() in ['', 'unknown', 'n/a', 'null', 'none']:
                    return None
    ...
    def validate_required_fields(self, asset: Dict[str, Any], required_fields: List[str]) -> List[str]:
        ...
        try:
            ...
            for field in required_fields:
                ...
                if value is None or str(value).strip() in ['', 'Unknown', 'null', 'None', 'N/A']:
    ...
    def _calculate_health_score(self, assets: List[Dict]) -> int:
        ...
        try:
            ...
            for asset in assets:
                ...
                critical_fields = ['hostname', 'ip_address', 'asset_type', 'environment']
