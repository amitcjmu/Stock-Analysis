...
class UserApprovalHandler:
    ...
    async def _log_security_event(self, event_type: str, user_id: str, target_user_id: str = None, details: Dict[str, Any] = None):
    ...
    async def _validate_role_change_permissions(self, actor_user_id: str, target_role: str) -> bool:
        ...
        if target_role == "platform_admin":
            is_platform_admin = any(role.role_type == "platform_admin" for role in actor_roles)
