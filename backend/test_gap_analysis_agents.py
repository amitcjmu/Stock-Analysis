...
def test_agent_imports():
    ...
    try:
        ...
        logger.info(
            f"CriticalAttributeAssessor: {assessor_metadata.name} - {assessor_metadata.description}"
        )

        prioritizer_metadata = GapPrioritizationAgent.agent_metadata()
        logger.info(
            f"GapPrioritizationAgent: {prioritizer_metadata.name} - {prioritizer_metadata.description}"
        )
