...
class TestPhase1MigrationPatterns:
    ...
    @pytest.mark.asyncio
    async def test_session_to_flow_migration(self, migration_service, sample_data_import):
    ...
    @pytest.mark.asyncio
    async def test_migration_rollback_capability(self, migration_service, mock_db_session):
    ...
    async def test_concurrent_migration_handling(self, migration_service):
        ...
        # First migration
        result_1 = await migration_service.migrate_session_to_flow(session_id, flow_id_1)
        
        # Second migration (should handle gracefully)
        result_2 = await migration_service.migrate_session_to_flow(session_id, flow_id_2)
