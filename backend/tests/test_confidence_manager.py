...
async def test_confidence_manager():
    ...
    try:
        ...
        operations = ["field_mapping", "asset_classification", "migration_strategy", "risk_assessment"]
    ...
    try:
        ...
        feedback_tests = [
            ...
            },
            {
                ...
                "was_correct": False,
                "feedback_details": {"field": "priority", "corrected_to": "business_criticality"}
            },
            {
        ...
        for i, feedback in enumerate(feedback_tests, 1):
            ...
            print(f"   Action: {feedback['user_action']} (confidence: {feedback['original_confidence']})")
