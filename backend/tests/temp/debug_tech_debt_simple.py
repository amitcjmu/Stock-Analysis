...
async def simple_test():
    ...
    if os_info:
        ...
        risk_score = tech_debt_analysis_agent._calculate_os_risk_score(lifecycle, os_info)
        print(f"Risk Score: {risk_score}")
    
    # Test OS analysis step by step
    print("\n=== OS ANALYSIS ===")
    os_analysis = await tech_debt_analysis_agent._analyze_operating_systems([test_asset])
