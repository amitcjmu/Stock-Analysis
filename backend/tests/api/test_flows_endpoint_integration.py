...
class TestFlowsEndpointIntegration:
    ...
    async def test_list_flows_empty_database(self, client: AsyncClient, db: AsyncSession, auth_headers: dict):
    ...
    async def test_list_flows_with_existing_flows(self, client: AsyncClient, db: AsyncSession, auth_headers: dict):
    ...
    async def test_list_flows_handles_missing_fields(self, client: AsyncClient, db: AsyncSession, auth_headers: dict):
    ...
    async def test_get_flow_status(self, client: AsyncClient, db: AsyncSession, auth_headers: dict):
    ...
    async def test_list_flows_with_status_filter(self, client: AsyncClient, db: AsyncSession, auth_headers: dict):
    ...
    async def test_flows_endpoint_requires_tenant_headers(self, client: AsyncClient, auth_token: str):
