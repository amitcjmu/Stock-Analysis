...
def test_get_import_data(service_layer):
    ...
    with patch('app.services.agents.agent_service_layer.DiscoveryFlowRepository') as mock_repo, \
         patch('app.services.agents.agent_service_layer.AsyncSessionLocal') as mock_session:
