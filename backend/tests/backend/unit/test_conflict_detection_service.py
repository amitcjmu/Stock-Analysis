...
class TestConflictDetectionService:
    ...
    def sample_import_records(self, sample_context):
        ...
        # Create a dummy data_import_id for testing
        ...
        return [
            RawImportRecord(
                ...
                raw_data={
                    ...
                    "empty_field": "",
                    "null_field": None,
                    "_source_file": "inventory_scan.csv",  # Store source file in raw_data
                },
                created_at=datetime.utcnow(),
            ),
            RawImportRecord(
                ...
                client_account_id=uuid.UUID(sample_context.client_account_id),
                engagement_id=uuid.UUID(sample_context.engagement_id),
                row_number=2,  # Required field
                raw_data={
                    "os_version": "Ubuntu 22.04.1",  # Another variation
                    "cpu_cores": "8",  # Conflict with custom_attributes
                    "environment": "prod",
                    "_source_file": "cmdb_export.json",  # Store source file in raw_data
                },
                created_at=datetime.utcnow(),
            ),
        ]
