...
class TestDiscoveryFlowPerformance:
    ...
    async def test_scalability_with_increasing_data_loads(
        ...
        assert medium_throughput > small_throughput * 0.1, "Medium scale should maintain some throughput"
        assert large_throughput > medium_throughput * 0.1, "Large scale should maintain some throughput"
