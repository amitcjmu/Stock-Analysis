...
def upgrade():
    ...
    op.create_index(
        "idx_crewai_flow_extensions_flow", "crewai_flow_state_extensions", ["flow_id"]
    )
...
def downgrade():
    ...
    # Drop indexes
    op.drop_index(
        "idx_crewai_flow_extensions_updated", table_name="crewai_flow_state_extensions"
    )
    op.drop_index(
        "idx_crewai_flow_extensions_flow", table_name="crewai_flow_state_extensions"
    )
    op.drop_index(
        "idx_crewai_flow_extensions_session", table_name="crewai_flow_state_extensions"
    )
