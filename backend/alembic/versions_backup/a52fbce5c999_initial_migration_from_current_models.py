...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_client_accounts_is_active"),
        "client_accounts",
        ["is_active"],
        unique=False,
    )
    op.create_index(
        op.f("ix_client_accounts_is_mock"), "client_accounts", ["is_mock"], unique=False
    )
    op.create_index(
        op.f("ix_client_accounts_slug"), "client_accounts", ["slug"], unique=True
    )
    op.create_table(
        "migration_logs",
    ...
    op.create_index(
        op.f("ix_user_profiles_status"), "user_profiles", ["status"], unique=False
    )
    op.create_table(
        "client_access",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_client_access_client_account_id"),
        "client_access",
        ["client_account_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_client_access_is_active"), "client_access", ["is_active"], unique=False
    )
    op.create_index(
        op.f("ix_client_access_user_profile_id"),
        "client_access",
        ["user_profile_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_engagements_is_active"), "engagements", ["is_active"], unique=False
    )
    op.create_index(
        op.f("ix_engagements_is_mock"), "engagements", ["is_mock"], unique=False
    )
    op.create_index(
        op.f("ix_engagements_status"), "engagements", ["status"], unique=False
    )
    op.create_table(
        "tags",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_user_account_associations_is_mock"),
        "user_account_associations",
        ["is_mock"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["parent_session_id"], ["data_import_sessions.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_data_import_sessions_status"),
        "data_import_sessions",
        ["status"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_enhanced_access_audit_log_action_type"),
        "enhanced_access_audit_log",
        ["action_type"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_enhanced_user_profiles_data_scope"),
        "enhanced_user_profiles",
        ["data_scope"],
        unique=False,
    )
    op.create_index(
        op.f("ix_enhanced_user_profiles_is_deleted"),
        "enhanced_user_profiles",
        ["is_deleted"],
        unique=False,
    )
    op.create_index(
        op.f("ix_enhanced_user_profiles_role_level"),
        "enhanced_user_profiles",
        ["role_level"],
        unique=False,
    )
    op.create_index(
        op.f("ix_enhanced_user_profiles_status"),
        "enhanced_user_profiles",
        ["status"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_soft_deleted_items_item_id"),
        "soft_deleted_items",
        ["item_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_soft_deleted_items_item_type"),
        "soft_deleted_items",
        ["item_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_soft_deleted_items_status"),
        "soft_deleted_items",
        ["status"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_access_audit_log_action_type"),
        "access_audit_log",
        ["action_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_access_audit_log_created_at"),
        "access_audit_log",
        ["created_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_access_audit_log_user_id"),
        "access_audit_log",
        ["user_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["session_id"], ["data_import_sessions.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["updated_by"],
            ["users.id"],
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_access_audit_log_action_type"), table_name="access_audit_log"
    )
    ...
    op.drop_index(
        op.f("ix_soft_deleted_items_item_type"), table_name="soft_deleted_items"
    )
    op.drop_index(
        op.f("ix_soft_deleted_items_item_id"), table_name="soft_deleted_items"
    )
    ...
    op.drop_index(
        op.f("ix_enhanced_user_profiles_status"), table_name="enhanced_user_profiles"
    )
    op.drop_index(
        op.f("ix_enhanced_user_profiles_role_level"),
        table_name="enhanced_user_profiles",
    )
    op.drop_index(
        op.f("ix_enhanced_user_profiles_is_deleted"),
        table_name="enhanced_user_profiles",
    ...
    op.drop_index(
        op.f("ix_data_import_sessions_status"), table_name="data_import_sessions"
    )
    op.drop_index(
    ...
    op.drop_index(
        op.f("ix_data_import_sessions_engagement_id"), table_name="data_import_sessions"
    )
    op.drop_index(
        op.f("ix_data_import_sessions_client_account_id"),
        table_name="data_import_sessions",
    )
    ...
    op.drop_index(
        op.f("ix_client_access_client_account_id"), table_name="client_access"
    )
