...
def upgrade() -> None:
    ...
    op.drop_index(
        "ix_agent_discovered_patterns_pattern_type",
    ...
    op.alter_column(
        "agent_discovered_patterns", "pattern_type", nullable=False, schema="migration"
    )
...
def downgrade() -> None:
    ...
    op.add_column(
        "agent_discovered_patterns",
        sa.Column("pattern_type_enum", patterntype_enum, nullable=True),
        schema="migration",
    )
