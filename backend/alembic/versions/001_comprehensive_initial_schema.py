...
def upgrade() -> None:
    ...
    op.create_table('user_roles',
        ...
        sa.ForeignKeyConstraint(['scope_client_id'], ['client_accounts.id'], name=op.f('fk_user_roles_scope_client_id_client_accounts')),
        sa.ForeignKeyConstraint(['scope_engagement_id'], ['engagements.id'], name=op.f('fk_user_roles_scope_engagement_id_engagements')),
    ...
    op.create_table('user_account_associations',
        ...
        sa.Column('created_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=True),
        sa.Column('created_by', sa.UUID(), nullable=True),
        sa.ForeignKeyConstraint(['client_account_id'], ['client_accounts.id'], name=op.f('fk_user_account_associations_client_account_id_client_accounts'), ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['created_by'], ['users.id'], name=op.f('fk_user_account_associations_created_by_users')),
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_user_account_associations_user_id_users'), ondelete='CASCADE'),
