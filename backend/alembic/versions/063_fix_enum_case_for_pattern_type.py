...
def upgrade() -> None:
    ...
    print(
        "🔧 Fixing PostgreSQL enum patterntype case to match SQLAlchemy expectations..."
    )
    ...
    if enum_exists and table_exists:
        print(
            "   📝 Existing enum found with lowercase values, recreating with uppercase..."
        )
    ...
    if table_exists:
        ...
        print(
            "   ✅ Created new enum with uppercase values (table will use it when created)"
        )
