...
def upgrade():
    ...
    op.create_table('users',
        ...
        sa.Column('default_client_account_id', postgresql.UUID(as_uuid=True), nullable=True),
        sa.Column('default_engagement_id', postgresql.UUID(as_uuid=True), nullable=True),
    ...
    op.add_column('users', sa.Column('default_engagement_id', postgresql.UUID(as_uuid=True), nullable=True))
    ...
    op.create_table('crewai_flow_state_extensions',
        ...
        # Flow metadata
        sa.Column('flow_type', sa.String(50), nullable=False, server_default="'discovery'"),
    ...
    op.create_table('discovery_flows',
        ...
        sa.Column('attribute_mapping_completed', sa.Boolean(), nullable=False, server_default='false'),
        sa.Column('data_cleansing_completed', sa.Boolean(), nullable=False, server_default='false'),
        sa.Column('inventory_completed', sa.Boolean(), nullable=False, server_default='false'),
        sa.Column('dependencies_completed', sa.Boolean(), nullable=False, server_default='false'),
        sa.Column('tech_debt_completed', sa.Boolean(), nullable=False, server_default='false'),
        ...
        sa.Column('learning_scope', sa.String(length=50), nullable=False, server_default="'engagement'"),
        sa.Column('memory_isolation_level', sa.String(length=20), nullable=False, server_default="'engagement'"),
    ...
    op.create_index(op.f('ix_migrations_client_account_id'), 'migrations', ['client_account_id'], unique=False)
    op.create_index(op.f('ix_migrations_engagement_id'), 'migrations', ['engagement_id'], unique=False)
    ...
    op.create_table('assets',
        ...
        sa.Column('asset_type', sa.Enum('server', 'database', 'application', 'network', 'load_balancer', 
                                       'storage', 'security_group', 'virtual_machine', 'container', 'other', 
                                       name='asset_type'), nullable=False),
        sa.Column('description', sa.Text(), nullable=True),
        ...
        sa.Column('planning_flow_id', postgresql.UUID(as_uuid=True), nullable=True),
        sa.Column('execution_flow_id', postgresql.UUID(as_uuid=True), nullable=True),
        sa.Column('source_phase', sa.String(50), nullable=True, server_default="'discovery'"),
        sa.Column('current_phase', sa.String(50), nullable=True, server_default="'discovery'"),
        sa.Column('phase_progression', postgresql.JSONB(astext_type=sa.Text()), server_default=sa.text("'{}'::jsonb"), nullable=True),
        ...
        sa.Column('six_r_strategy', sa.Enum('rehost', 'replatform', 'refactor', 'rearchitect', 
                                           'replace', 'repurchase', 'retire', 'retain', 
                                           name='sixr_strategy'), nullable=True),
        sa.Column('mapping_status', sa.String(20), nullable=True),
        sa.Column('migration_priority', sa.Integer(), nullable=True, server_default='5'),
        ...
        sa.Column('migration_status', sa.Enum('discovered', 'assessed', 'planned', 'migrating', 
                                            'migrated', 'failed', 'excluded', 
                                            name='asset_status'), nullable=True, server_default="'discovered'"),
        
        # Dependencies and relationships
        sa.Column('dependencies', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column('related_assets', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        ...
        sa.Column('field_mappings_used', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    op.create_table('data_imports',
        sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('filename', sa.String(), nullable=False),  # Using 'filename' not 'source_filename'
        sa.Column('status', sa.Enum('pending', 'uploading', 'uploaded', 'processing', 'validating',
                                   'processed', 'completed', 'failed', 'cancelled', 'archived',
        ...
        sa.Column('file_size', sa.Integer(), nullable=True),  # Using 'file_size' not 'file_size_bytes'
        sa.Column('mime_type', sa.String(), nullable=True),  # Using 'mime_type' not 'file_type'
    ...
    op.create_index('ix_asset_dependencies_asset_id', 'asset_dependencies', ['asset_id'], unique=False)
    op.create_index('ix_asset_dependencies_depends_on_asset_id', 'asset_dependencies', ['depends_on_asset_id'], unique=False)
    ...
    op.create_index('ix_migration_waves_client_account_id', 'migration_waves', ['client_account_id'], unique=False)
    op.create_index('ix_migration_waves_engagement_id', 'migration_waves', ['engagement_id'], unique=False)
    op.create_index('ix_migration_waves_wave_number', 'migration_waves', ['wave_number'], unique=False)
    ...
    op.create_index('ix_cmdb_sixr_analyses_client_account_id', 'cmdb_sixr_analyses', ['client_account_id'], unique=False)
    op.create_index('ix_cmdb_sixr_analyses_engagement_id', 'cmdb_sixr_analyses', ['engagement_id'], unique=False)
    ...
    op.create_index('ix_llm_usage_tracking_client_account_id', 'llm_usage_tracking', ['client_account_id'])
    op.create_index('ix_llm_usage_tracking_agent_name', 'llm_usage_tracking', ['agent_name'])
    ...
    op.create_index('ix_user_feedback_client_account_id', 'user_feedback', ['client_account_id'])
