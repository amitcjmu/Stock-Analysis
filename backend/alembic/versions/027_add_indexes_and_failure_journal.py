...
def upgrade() -> None:
    ...
    if _table_exists(inspector, "assets", schema):
        if not _index_exists(
            ...
            result = conn.execute(
                ...
                AND indexname = 'ix_assets_client_engagement_readiness'
        ...
        if not _index_exists(inspector, "assets", "ix_assets_discovery_status", schema):
            ...
            result = conn.execute(
                ...
                AND indexname = 'ix_assets_discovery_status'
    ...
    if not _table_exists(inspector, "failure_journal", schema):
        ...
        result = conn.execute(
            ...
            AND table_name = 'failure_journal'
        ...
        if not result.fetchone():
            ...
            op.create_table(
                ...
                sa.Column(
                    "engagement_id", postgresql.UUID(as_uuid=True), nullable=False
                ),
    ...
    if _table_exists(inspector, "failure_journal", schema) and not _index_exists(
        ...
        result = conn.execute(
            ...
            AND indexname = 'ix_failure_journal_engagement_op'
