...
class SecurityTestSuite:
    ...
    async def run_all_tests(self):
        ...
        logger.info("🔒 Starting CrewAI Security Validation Tests")
        logger.info("=" * 60)
    ...
    async def test_cache_key_security(self):
        ...
        logger.info("🔑 Testing Cache Key Security...")
    ...
    async def test_sensitive_data_detection(self):
        ...
        logger.info("🔍 Testing Sensitive Data Detection...")
    ...
    async def test_encryption_infrastructure(self):
        ...
        logger.info("🔐 Testing Encryption Infrastructure...")
    ...
    async def test_secure_checkpoint_manager(self):
        ...
        logger.info("🛡️ Testing Secure Checkpoint Manager...")
    ...
    async def test_secure_agent_registry(self):
        ...
        logger.info("🤖 Testing Secure Agent Registry...")
    ...
    async def test_comprehensive_validation(self):
        ...
        logger.info("🔍 Testing Comprehensive Security Validation...")
    ...
    def print_test_summary(self):
        ...
        logger.info("=" * 60)
        logger.info("🔒 CrewAI Security Test Summary")
