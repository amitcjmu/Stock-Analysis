...
class DeprecationMiddleware(BaseHTTPMiddleware):
    ...
    ENDPOINT_MAPPINGS = {
        ...
        # Frontend-used V1 endpoints that need migration
        "/api/v1/discovery/flows/active": "/api/v3/discovery-flow/flows?status=active",
        "/api/v1/discovery/flow/status/{id}": "/api/v3/discovery-flow/flows/{id}/status",
        "/api/v1/discovery/flow/{id}/validation-status": "/api/v3/discovery-flow/flows/{id}/validate",
        "/api/v1/discovery/flow/{id}/agent-insights": "/api/v3/discovery-flow/flows/{id}/insights",
        "/api/v1/discovery/flow/{id}/processing-status": "/api/v3/discovery-flow/flows/{id}/processing-status",
        
        # Additional V1 Discovery Flow endpoints to migrate
        "/api/v1/unified-discovery/flow/initialize": "/api/v3/discovery-flow/flows",
        "/api/v1/unified-discovery/flow/execute": "/api/v3/discovery-flow/flows/{id}/execute/{phase}",
        "/api/v1/unified-discovery/flow/continue/{id}": "/api/v3/discovery-flow/flows/{id}/resume",
        "/api/v1/unified-discovery/flow/complete/{id}": "/api/v3/discovery-flow/flows/{id}/complete",
        "/api/v1/unified-discovery/flow/pause/{id}": "/api/v3/discovery-flow/flows/{id}/pause",
        "/api/v1/unified-discovery/flow/resume/{id}": "/api/v3/discovery-flow/flows/{id}/resume",
        "/api/v1/unified-discovery/assets/{id}": "/api/v3/discovery-flow/flows/{id}/assets",
