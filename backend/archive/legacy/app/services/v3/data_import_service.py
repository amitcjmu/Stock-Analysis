...
class V3DataImportService:
    ...
    async def create_import(
        ...
        try:
            ...
            # Note: V3 API creates the flow separately and links it to the import
            # We no longer auto-create flows here to avoid duplicates
            
            logger.info(f"Created import {data_import.id}")
