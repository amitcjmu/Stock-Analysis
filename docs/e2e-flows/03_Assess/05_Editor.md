...
The Editor page continues to function as previously documented, with the following key reminders:
...
- Uses `migration.assets` table (formerly referenced as `asset_inventory`)
